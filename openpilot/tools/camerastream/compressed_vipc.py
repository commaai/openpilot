...
from openpilot.tools.lib.framereader import FfmpegStreamDecoder
...
def decoder(addr, vipc_server, vst, nvidia, W, H, debug=False):
  ...
  hwaccel = "cuda" if nvidia else "auto"
  codec = FfmpegStreamDecoder(W, H, pix_fmt="nv12", hwaccel=hwaccel, loglevel="error" if debug else "quiet")
...
if __name__ == "__main__":
  ...
  parser.add_argument("--nvidia", action="store_true", help="Use FFmpeg CUDA/NVIDIA hardware decoding")
