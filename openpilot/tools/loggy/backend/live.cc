...
uint8_t alert_status_to_level(cereal::SelfdriveState::AlertStatus status) {
  switch (status) {
    case cereal::SelfdriveState::AlertStatus::NORMAL: return 20;
    case cereal::SelfdriveState::AlertStatus::USER_PROMPT: return 30;
    case cereal::SelfdriveState::AlertStatus::CRITICAL: return 40;
  }
  return 20;
}
...
TimelineSpanKind timeline_kind_for_selfdrive(cereal::SelfdriveState::AlertStatus status, bool enabled) {
  ...
  switch (status) {
    case cereal::SelfdriveState::AlertStatus::NORMAL: return TimelineSpanKind::Engaged;
    case cereal::SelfdriveState::AlertStatus::USER_PROMPT: return TimelineSpanKind::AlertInfo;
    case cereal::SelfdriveState::AlertStatus::CRITICAL: return TimelineSpanKind::AlertCritical;
  }
...
void append_timeline_point(std::vector<TimelineSpan> *spans, double mono_time, TimelineSpanKind kind) {
  if (spans == nullptr || kind == TimelineSpanKind::None) return;
