...
check "named header structs" \
  ...
  84
# 21020->21045 (2026-07-06): timeline gap bridging with disengage barriers (red-team fix).
# Prior: 21004->21020 (2026-07-06): ship fixes — signal table flex, computed multiline dedup,
