...
struct ChestnutState {
  ...
  pcieLtssm @7 :UInt8;  # link state to the GPU, 0x78 is L0
  supplyVoltage @8 :UInt16;  # mV at the XT60, measured by the ASM
  supplyCurrent @9 :Int16;  # mA at the XT60, measured by the ASM
}
