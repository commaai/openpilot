...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"Offroad_ChestnutFirmwareUpdateFailed", {CLEAR_ON_MANAGER_START, JSON}},
    {"Offroad_ChestnutModelNotCompiled", {CLEAR_ON_MANAGER_START, JSON}},
    {"Offroad_ChestnutNotDetected", {CLEAR_ON_MANAGER_START, JSON}},
    {"Offroad_ChestnutPcieLinkUnavailable", {CLEAR_ON_MANAGER_START, JSON}},
    {"Offroad_ChestnutUsbLinkSlow", {CLEAR_ON_MANAGER_START, JSON}},
