...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"Offroad_ChestnutUncompiled", {CLEAR_ON_MANAGER_START, JSON}},
    {"Offroad_ChestnutUpdateFailed", {CLEAR_ON_MANAGER_START, JSON}},
    {"Offroad_ChestnutUsbSlow", {CLEAR_ON_MANAGER_START, JSON}},
    ...
    {"ChestnutModelError", {CLEAR_ON_MANAGER_START | CLEAR_ON_IGNITION_ON, BOOL}},
