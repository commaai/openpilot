...
def replay_process(
  ...
  captured_output_store: dict[str, dict[str, str]] | None = None, disable_progress: bool = False, disable_migrations: bool = False,
  ...
  all_msgs = list(lr) if disable_migrations else migrate_all(
    lr,
    manager_states=True,
