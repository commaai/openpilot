...
class BigInputDialog(BigDialogBase):
  ...
  def _update_state(self):
    ...
    if last_mouse_event.left_down and rl.check_collision_point_rec(last_mouse_event.pos, self._top_right_button_rect) and self._keyboard.text():
  ...
  def _handle_mouse_press(self, mouse_pos: MousePos):
    ...
    if rl.check_collision_point_rec(mouse_pos, self._top_right_button_rect) and self._keyboard.text():
      self._keyboard.backspace()
