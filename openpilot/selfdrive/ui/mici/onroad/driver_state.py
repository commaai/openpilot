...
class DriverStateRenderer(Widget):
  ...
  def get_driver_data(self):
    ...
    # undo sign flip in face_orientation_from_model to match UI convention, and the RHD mirroring the policy applies
    self._face_yaw = -dm_state.visionPolicyState.pose.yaw * (-1 if self._is_rhd else 1)
