...
class HudRenderer(Widget):
  ...
  def _update_state(self) -> None:
    ...
    if engaged and not self._engaged and ui_state.usbgpu_active is False:
  ...
  def _draw_model_source(self, rect: rl.Rectangle) -> None:
    ...
    big_failed = ui_state.usbgpu_active is False
    self._small_model_engaged &= big_failed
    if ui_state.usbgpu_loading or ui_state.usbgpu_active is None:
