...
class HudRenderer(Widget):
  def __init__(self):
    ...
    self._txt_egpu_green: rl.Texture = gui_app.texture('icons_mici/egpu.png', 60, 44)
    self._txt_egpu_grey: rl.Texture = gui_app.texture('icons_mici/egpu_grey.png', 60, 44)
