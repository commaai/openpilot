...
from openpilot.common.camera120 import camera120_enabled, CAMERA120_UNUSED_SERVICES
...
class SelfdriveD:
  def __init__(self, CP=None):
    ...
    self.camera120 = camera120_enabled()
  ...
  def update_events(self, CS):
    ...
    if not self.camera120 and cal_status != log.ExtrinsicsCalibration.Status.calibrated:
