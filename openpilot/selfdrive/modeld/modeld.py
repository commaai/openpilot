...
from openpilot.selfdrive.modeld.helpers import usbgpu_present, usbgpu_compiled, get_tg_input_devices, load_modeld_jits
...
class ModelState:
  ...
  def __init__(self, cam_w: int, cam_h: int, usbgpu: bool):
    ...
    jits = load_modeld_jits(usbgpu, self.WARP_DEV)
