...
from openpilot.common.hardware.usb import CHESTNUT_USB_IDS, USB_DEVICES_PATH, is_current_chestnut_firmware
...
def usbgpu_present() -> bool:
  for d in USB_DEVICES_PATH.glob("*"):
    try:
      ...
      if usb_id in CHESTNUT_USB_IDS and is_current_chestnut_firmware(product):
        return True
    except Exception:
      pass
  return False
