...
from openpilot.common.hardware import PC, COMMA
...
procs = [
  ...
  PythonProcess("qcomgpsd", "openpilot.system.qcomgpsd.qcomgpsd", qcomgps, enabled=COMMA),
  ...
  PythonProcess("ubloxd", "openpilot.system.ubloxd.ubloxd", ublox, enabled=COMMA),
  PythonProcess("pigeond", "openpilot.system.ubloxd.pigeond", ublox, enabled=COMMA),
  ...
  PythonProcess("modem", "openpilot.common.hardware.comma.modem", always_run, enabled=COMMA),
