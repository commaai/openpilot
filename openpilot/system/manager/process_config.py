...
procs = [
  ...
  NativeProcess("camerad", "openpilot/system/camerad", ["./camerad"], or_(only_onroad, livestream), enabled=not WEBCAM),
  ...
  PythonProcess("webrtcd", "openpilot.system.webrtc.webrtcd", or_(only_onroad, livestream)),
