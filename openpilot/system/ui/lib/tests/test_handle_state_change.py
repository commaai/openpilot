...
def _make_wm(testcase: unittest.TestCase, connections=None):
  ...
  wm._need_auth = []
  wm._activated = []
  wm._update_networks = mock.MagicMock()
  wm._update_active_connection_info = mock.MagicMock()
  wm._get_active_wifi_connection = mock.MagicMock(return_value=(None, None))
  return wm
...
class TestDisconnected(OpenpilotTestCase):
  ...
  def test_connection_removed_keeps_other_connecting(self):
    ...
    wm = _make_wm(self, connections={"B": "/path/B"})
...
class TestDeactivating(OpenpilotTestCase):
  def test_deactivating_noop_for_non_connection_removed(self):
  ...
  def test_deactivating_connection_removed(self, status, expected_clears):
...
class TestPrepareConfig(OpenpilotTestCase):
  def test_user_initiated_skips_dbus_lookup(self):
    ...
    """
    wm = _make_wm(self, connections={"A": "/path/A", "B": "/path/B"})
    wm._set_connecting("B")
  ...
  def test_auto_connect_conn_path_not_in_connections(self):
    """DBus returns a conn_path that doesn't match any known connection."""
    wm = _make_wm(self, connections={"Other": "/path/other"})
...
class TestNeedAuth(OpenpilotTestCase):
  ...
  def test_need_auth_then_failed_no_double_fire(self):
...
class TestActivated(OpenpilotTestCase):
  def test_sets_connected(self):
    ...
    wm = _make_wm(self, connections={"MyNet": "/path/mynet"})
    cb = mock.MagicMock()
...
class TestThreadRaces(OpenpilotTestCase):
  def test_prepare_race_user_tap_during_dbus(self):
  ...
  def test_activated_race_user_tap_during_dbus(self):
  ...
  def test_init_wifi_state_race_user_tap_during_dbus(self):
    ...
    wm._router_main = mock.MagicMock()

    state_reply = mock.MagicMock()
...
class TestFullSequences(OpenpilotTestCase):
  def test_normal_connect(self):
    ...
    """
    wm = _make_wm(self, connections={"Home": "/path/home"})
  ...
  def test_wrong_password_then_retry(self):
    ...
    """
    wm = _make_wm(self, connections={"Sec": "/path/sec"})
    cb = mock.MagicMock()
    wm.add_callbacks(need_auth=cb)
  ...
  def test_forget_while_connecting(self):
    ...
    """
    wm = _make_wm(self, connections={"A": "/path/A", "Other": "/path/other"})
  ...
  def test_forget_connected_network(self):
    ...
    """
    wm = _make_wm(self, connections={"A": "/path/A"})
    wm._wifi_state = WifiState(ssid="A", status=ConnectStatus.CONNECTED)
  ...
  def test_forget_A_connect_B_late_new_connection(self):
  ...
  def test_network_lost_during_connection(self):
    ...
    """
    wm = _make_wm(self, connections={"Hotspot": "/path/hs"})
    cb = mock.MagicMock()
    wm.add_callbacks(need_auth=cb)
  ...
  def test_ssid_not_found(self):
    ...
    """
    wm = _make_wm(self, connections={"GoneNet": "/path/gone"})
    cb = mock.MagicMock()
    wm.add_callbacks(need_auth=cb)
...
class TestWorkerErrorRecovery(OpenpilotTestCase):
  ...
  def _mock_init_restores(self, wm, ssid, status):
    ...
    wm._init_wifi_state = mock_init
    return mock_init

  def test_activate_dbus_error_resyncs(self):
    ...
    wm = _make_wm(self, connections={"A": "/path/A", "B": "/path/B"})
    wm._wifi_device = "/dev/wifi0"
    wm._nm = mock.MagicMock()
    wm._wifi_state = WifiState(ssid="A", status=ConnectStatus.CONNECTED)
    wm._router_main = mock.MagicMock()

    error_reply = mock.MagicMock()
    error_reply.header.message_type = MessageType.error
    wm._router_main.send_and_get_reply.return_value = error_reply

    mock_init = self._mock_init_restores(wm, "A", ConnectStatus.CONNECTED)
  ...
  def test_connect_to_network_dbus_error_resyncs(self):
    ...
    workers = []
    self.enterContext(mock.patch('openpilot.system.ui.lib.wifi_manager.threading.Thread',
