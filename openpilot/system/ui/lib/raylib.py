...
def __getattr__(name: str):
  ...
  value = getattr(_gpu, name)
  if CPU_BACKEND and callable(value) and name not in _CPU_ABI_CONSTRUCTORS and not isinstance(value, EnumType):
