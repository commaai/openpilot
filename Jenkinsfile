    ...
    parallel (
      ...
      'car tests': {
        pcStage("car tests") {
          ...
          sh label: "run car tests", script: "cd selfdrive/car/tests && MAX_EXAMPLES=100 INTERNAL_SEG_CNT=250 INTERNAL_SEG_LIST=test_models_segs.txt FILEREADER_CACHE=1 \
                                              pytest test_models.py test_car_interfaces.py"
        }
      },
