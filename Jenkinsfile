...
//             sh "scons --clean && scons --no-cache --random -j42"
            sh "INTERNAL_SEG_LIST='selfdrive/car/tests/test_models_segs.txt' FILEREADER_CACHE='1' PYTHONPATH='${WORKSPACE}' pytest -n42 --dist=loadscope selfdrive/car/tests/test_models.py"
          }
