...
class NavScroller(NavWidget, Scroller):
  ...
  def __init__(self, **kwargs):
    ...
    self._scroller.set_enabled(lambda: self.enabled and not self._dragging_down and not self._playing_dismiss_animation)
...
class NavRawScrollPanel(NavWidget):
  ...
  def __init__(self):
    ...
    self._scroll_panel.set_enabled(lambda: self.enabled and not self._dragging_down and not self._playing_dismiss_animation)
