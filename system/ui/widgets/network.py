...
from openpilot.system.ui.lib.application import gui_app, FPS
...
class NavButton(Widget):
  def __init__(self, text: str):
    ...
    self._x_pos_filter = FirstOrderFilter(0.0, 0.05, 1 / FPS, initialized=False)
    self._y_pos_filter = FirstOrderFilter(0.0, 0.05, 1 / FPS, initialized=False)
