...
class Toggle(Widget):
  ...
  def handle_input(self):
    ...
    if self._state:
      ...
      print(self._rect.x, self._rect.y, self._rect.width, self._rect.height)
      print(self._last_rect.x, self._last_rect.y, self._last_rect.width, self._last_rect.height)
      if self._rect_changed():
        print("Rect changed:")
        return 0
