...
public:
  V4LEncoder(const EncoderInfo &encoder_info, int in_width, int in_height, cereal::EncodeIndex::Type codec)
     : VideoEncoder(encoder_info, in_width, in_height, codec) { encoder_init(); }
  ~V4LEncoder();
  void encoder_init();
