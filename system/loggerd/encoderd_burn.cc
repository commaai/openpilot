...
#define BURN_ENCODER_COUNT 2  // Number of parallel encoders for stress testing
...
*/
#define BURN_FPS 120           // 60 fps for maximum stress
#define BURN_BITRATE (10 * 1000000)  // 100 Mbps for maximum load
