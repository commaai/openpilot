...
class TestRegistration(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.persist_patcher = mock.patch("system.athena.registration.PERSIST", self.persist.name)
  ...
  def test_valid_cache(self):
    ...
    with mock.patch("system.athena.registration.api_get", autospec=True) as m:
