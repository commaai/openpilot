...
int build_initial_config(uint8_t *dst, const SensorInfo *s, std::vector<uint32_t> &patches) {
  ...
  */
  ...
  dst += write_cont(dst, 0xa3c, {
    0x00000003,
    ((s->frame_width - 1) << 16) | (s->frame_width*2 - 1),
    0x30036666,
    0x00000000,
    0x00000000,
    s->frame_width*2 - 1,
    ((s->frame_height - 1) << 16) | (s->frame_height*2 - 1),
    0x30036666,
    0x00000000,
    0x00000000,
    s->frame_height*2 - 1,
  ...
  dst += write_cont(dst, 0xa68, {
    0x00000003,
    ((s->frame_width/2 - 1) << 16) | (s->frame_width*2 - 1),
    0x3006cccc,
    0x00000000,
    0x00000000,
    s->frame_width*2 - 1,
    ((s->frame_height/2 - 1) << 16) | (s->frame_height*2 - 1),
    0x3006cccc,
    0x00000000,
    0x00000000,
    s->frame_height*2 - 1,
