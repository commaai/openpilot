...
const struct i2c_random_wr_payload init_array_ox03c10[] = {
  ...
  */
  ...
  // horizontal timings
  {0x380c, 0x07}, {0x380d, 0xe4}, // dcg
  {0x384c, 0x03}, {0x384d, 0x46}, // spd
  {0x388c, 0x02}, {0x388d, 0x22}, // vs

  // rows per frame
  {0x380e, 0x05}, {0x380f, 0x2a},
  ...
  // all black level targets are 0
  {0x4026, 0x00}, {0x4027, 0x00},
  {0x4028, 0x00}, {0x4029, 0x00},
  {0x402a, 0x00}, {0x402b, 0x00},
  {0x402c, 0x00}, {0x402d, 0x00},
