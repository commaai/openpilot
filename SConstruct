...
lenv = {
  ...
  "LD_LIBRARY_PATH": [Dir(f"#third_party/acados/{arch}/lib").relpath,Dir(f"#../../third_party/acados/{arch}/lib").relpath],
...
qt_env['RPATH'] += [Dir(f"#third_party/maplibre-native-qt/{arch}/lib").srcnode().relpath,Dir(f"#../../third_party/maplibre-native-qt/{arch}/lib").srcnode().relpath]
qt_env['LIBS'] = qt_libs
