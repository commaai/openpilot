...
#define __pyx_n_u_CLEAR_ON_IGNITION_ON __pyx_string_tab[2]
 ...
 *     elif c_val == ParamKeyType.DEVELOPMENT_ONLY:             # <<<<<<<<<<<<<<
 *         return __pyx_enum.DEVELOPMENT_ONLY
 *     elif c_val == ParamKeyType.CLEAR_ON_IGNITION_ON:
*/
...
*/
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_convert_vector_to_py_std_3a__3a_string(__pyx_v_self->p->allKeys()); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 124, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 *     ('CLEAR_ON_OFFROAD_TRANSITION', __Pyx_PyLong_From_enum__ParamKeyType(CLEAR_ON_OFFROAD_TRANSITION)),             # <<<<<<<<<<<<<<
 *     ('DEVELOPMENT_ONLY', __Pyx_PyLong_From_enum__ParamKeyType(DEVELOPMENT_ONLY)),
 *     ('CLEAR_ON_IGNITION_ON', __Pyx_PyLong_From_enum__ParamKeyType(CLEAR_ON_IGNITION_ON)),
*/
 ...
 * 
*/
  __pyx_t_5 = __Pyx_PyLong_From_enum__ParamKeyType(CLEAR_ON_IGNITION_ON); if (unlikely(!__pyx_t_5)) __PYX_ERR(1, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {1, 0, 0, 1, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 123, 13};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_self};
    __pyx_mstate_global->__pyx_codeobj_tab[12] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_common_params_pyx_pyx, __pyx_mstate->__pyx_n_u_all_keys, __pyx_k_4r, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[12])) goto bad;
  }
