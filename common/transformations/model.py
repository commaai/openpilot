...
segnet_frame_from_camera_frame = np.array([
  [float(SEGNET_SIZE[0]) / FULL_FRAME_SIZE[0],  0.0],
...
model_intrinsics = np.array([
  [FOCAL / model_zoom,  0.0,  MODEL_CX],
  [0.0,  FOCAL / model_zoom,  MODEL_CY],
  [0.0,  0.0,                      1.0]])
...
calmodel_zoom = 1.5 / 1.0
calmodel_intrinsics = np.array([
  [FOCAL / calmodel_zoom,  0.0,  0.5 * CALMODEL_INPUT_SIZE[0]],
  [0.0,  FOCAL / calmodel_zoom,                   CALMODEL_CY],
  [0.0,  0.0,                                             1.0]])
...
bigmodel_zoom = 1.0 / 1.0
bigmodel_intrinsics = np.array([
  [FOCAL / bigmodel_zoom,  0.0,  0.5 * BIGMODEL_INPUT_SIZE[0]],
  [0.0,  FOCAL / bigmodel_zoom,             256 + MEDMODEL_CY],
  [0.0,  0.0,                                             1.0]])
