...
git config lfs.url https://gitlab.com/andiradulescu/openpilot-tiny-rebase.git/info/lfs
git config lfs.pushurl ssh://git@gitlab.com/andiradulescu/openpilot-tiny-rebase.git
