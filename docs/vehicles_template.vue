...
<section>
    <div class="container">
        <div class="title-section">
            ...
            <p class="font-large">A supported vehicle is one that just works when you install openpilot on a compatible device. <!--Supported cars are arranged into three tiers: Gold, Silver, and Bronze.--> Every car performs differently with openpilot, but we aim for all supported cars to provide a solid highway experience in the US market. Check out the YouTube videos in the chart below for some real world examples of openpilot in use.</p>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="rating-row">
            ...
            <div class="rating-row-item rating-row-item-secondary">
                <p>openpilot Longitudinal</p>
                <div class="rating-item">
                    <img src="/supported-cars/icon-star-full.svg" alt="">
                    <p>openpilot is able to control gas and brakes</p>
                </div>
                <div class="rating-item">
            ...
            <div class="rating-row-item rating-row-item-secondary">
                <p>Full-Speed Range (FSR) Longitudinal</p>
                <div class="rating-item">
                    <img src="/supported-cars/icon-star-full.svg" alt="">
        ...
        <div class="rating-row">
            ...
            <div class="rating-row-item rating-row-item-secondary">
                <p>Full-Speed Range (FSR) Steering</p>
                <div class="rating-item">
                    <img src="/supported-cars/icon-star-full.svg" alt="">
        ...
        <div class="rating-row" style="border-bottom: none;">
            ...
            <div class="rating-row-item rating-row-item-secondary">
                ...
                <div class="rating-item">
                    <img src="/supported-cars/icon-star-empty.svg" alt="">
                    <p>Low user count, community maintained, harness hardware sold by comma</p>
                </div>
            </div>
    ...
    <div class="container">
        <div class="table-container" role="table">
            ...
            <div class="tier tier-{{tier}}">
                <span class="font-Monument">{{tier}} <span style="opacity:0.67;"><br>38 cars</span></span>
                <p>The best openpilot experience. Great highway driving with continual updates.</p>
            </div>

            <div class="flex-table header">
                <div class="flex-row first col-1" role="columnheader">Make</div>
                <div class="flex-row col-2" role="columnheader">Model</div>
                <div class="flex-row col-3" role="columnheader">Supported Package</div>
                <div class="flex-row mobile-hide col-even" role="columnheader">openpilot Longitudinal</div>
                <div class="flex-row mobile-hide col-even" role="columnheader">FSR Longitudinal</div>
                <div class="flex-row mobile-hide col-even" role="columnheader">FSR Steering</div>
                <div class="flex-row mobile-hide col-even" role="columnheader">Steering <br>torque</div>
                <div class="flex-row mobile-hide col-even" role="columnheader">Actively <br>Maintained</div>
            </div>

            {% for row in car_rows %}
            <div class="flex-table row row-{{tier}}" >
                <div class="flex-row first col-1"><span class="make-icon make-genesis">{{row[0]}}</span></div>
                ...
                <div class="flex-row flex-row-star col-even">{{row[3]}}</div>
                <div class="flex-row flex-row-star col-even">{{row[4]}}</div>
                <div class="flex-row flex-row-star col-even">{{row[5]}}</div>
                <div class="flex-row flex-row-star col-even">{{row[6]}}</div>
                <div class="flex-row flex-row-star col-even">{{row[7]}}</div>
            </div>
            {% endfor %}
            {% endfor %}
        </div>
...
<section>
    <div class="container">
        ...
        <button class="accordion" @click="toggleFaq(0)">What is openpilot?</button>
            ...
            <button class="accordion" @click="toggleFaq(11)">What is Cabana?</button>
            <div class="panel faq" v-bind:style="{maxHeight: getFaqHeight(11)}">
            <p>Cabana is comma’s web app that allows you to inspect, label, and plot vehicle data collected by your panda. Cabana is accessible through <a href="https://connect.comma.ai/" target="_blank" rel="noopener">connect</a>; select a drive, click on the "Open in Cabana" button at the bottom. Only drives recorded with CAN data can be viewed in Cabana.</p>
            </div>

            <button class="accordion" @click="toggleFaq(12)">What is a fingerprint?</button>
            ...
            <button class="accordion" @click="toggleFaq(13)">What does it mean to be a community supported vehicle?</button>
            <div class="panel faq" v-bind:style="{maxHeight: getFaqHeight(13)}">
            <p>Community supported vehicles are vehicles not verified by comma to support our vehicle safety model. Be extra cautious using them.</p>

            <p>To promote a car from community maintained, it must meet a few requirements. We must own one from the brand, we must sell the harness for it, has full ISO26262 in both panda and openpilot, there must be a path forward for longitudinal control, it must have AEB still enabled, and it must support fingerprinting 2.0.</p>
            </div>

            <button class="accordion" @click="toggleFaq(14)">Where is my dongle ID?</button>
            <div class="panel faq" v-bind:style="{maxHeight: getFaqHeight(14)}">
            <p>The dongle ID of your device can be found in Settings of the device in the Device tab. </p>
            </div>

            <button class="accordion" @click="toggleFaq(15)">How do I leave feedback for openpilot?</button>
            <div class="panel faq" v-bind:style="{maxHeight: getFaqHeight(15)}">
