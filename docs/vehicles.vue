    ...
    <div class="container">
        <div class="table-container" role="table">
                    ...
                    <div class="tier tier-gold">
                        <span class="font-Monument">Gold <span style="opacity:0.67;"><br>27 cars</span></span>
                    ...
                    <div class="flex-table header">
                        ...
                        <div class="flex-row mobile-hide col-even" role="columnheader">openpilot ACC</div>
                        <div class="flex-row mobile-hide col-even" role="columnheader">Stop and Go</div>
                        <div class="flex-row mobile-hide col-even" role="columnheader">Steer to 0</div>
                        <div class="flex-row mobile-hide col-even" role="columnheader">Steering Torque</div>
                        <div class="flex-row mobile-hide col-even" role="columnheader">Actively Maintained</div>
                    </div>
                    ...
                    <div class="tier tier-silver">
                        <span class="font-Monument">Silver <span style="opacity:0.67;"><br>71 cars</span></span>
                        <p>The best openpilot experience. Great highway driving and beyond.</p>
                    </div>
                    ...
                    <div class="tier tier-bronze">
                        <span class="font-Monument">Bronze <span style="opacity:0.67;"><br>58 cars</span></span>
                        <p>The best openpilot experience. Great highway driving and beyond.</p>
                    </div>
