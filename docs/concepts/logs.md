...
qcameras are H.264-encoded, lower-resolution versions of `fcamera.hevc`. The video shown in [comma connect](https://connect.comma.ai/) is from the qcameras.
