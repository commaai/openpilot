...
Testing on PC
------
For simplified development and experimentation, openpilot car be ran in the CARLA driving simulator, which allows you to develop openpilot without a car. The whole setup should only take a few minutes. 
