...
class TestFollowingDistance:
  def test_following_distance(self):
    ...
    assert simulation_steady_state == pytest.approx(correct_steady_state - (err_ratio * correct_steady_state + .5), correct_steady_state + (err_ratio * correct_steady_state + .5))
