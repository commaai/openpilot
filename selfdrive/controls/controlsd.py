...
class Controls:
  ...
  def state_control(self, CS):
    ...
    if not self.joystick_mode:
      ...
      iter_since_plan = self.sm.frame - self.sm.rcv_frame['longitudinalPlan']
      actuators.accel = self.LoC.update(self.active, CS, self.CP, long_plan, pid_accel_limits, iter_since_plan)
