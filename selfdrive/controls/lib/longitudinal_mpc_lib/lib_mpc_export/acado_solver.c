...
{
acadoWorkspace.H[(iRow * 36 + 144) + (iCol + 4)] += + Gu1[0]*Gu2[0] + Gu1[1]*Gu2[1] + Gu1[2]*Gu2[2] + Gu1[3]*Gu2[3];
}

void acado_setBlockH11_R1( int iRow, int iCol, real_t* const R11 )
{
acadoWorkspace.H[(iRow * 36 + 144) + (iCol + 4)] = R11[0];
}

void acado_zeroBlockH11( int iRow, int iCol )
{
acadoWorkspace.H[(iRow * 36 + 144) + (iCol + 4)] = 0.0000000000000000e+00;
}

void acado_copyHTH( int iRow, int iCol )
{
acadoWorkspace.H[(iRow * 36 + 144) + (iCol + 4)] = acadoWorkspace.H[(iCol * 36 + 144) + (iRow + 4)];
}
...
acadoWorkspace.H[38] = 0.0000000000000000e+00;
acadoWorkspace.H[39] = 0.0000000000000000e+00;
...
acadoWorkspace.H[36] += + Gx1[1]*Gx2[0] + Gx1[5]*Gx2[4] + Gx1[9]*Gx2[8] + Gx1[13]*Gx2[12];
acadoWorkspace.H[37] += + Gx1[1]*Gx2[1] + Gx1[5]*Gx2[5] + Gx1[9]*Gx2[9] + Gx1[13]*Gx2[13];
acadoWorkspace.H[38] += + Gx1[1]*Gx2[2] + Gx1[5]*Gx2[6] + Gx1[9]*Gx2[10] + Gx1[13]*Gx2[14];
acadoWorkspace.H[39] += + Gx1[1]*Gx2[3] + Gx1[5]*Gx2[7] + Gx1[9]*Gx2[11] + Gx1[13]*Gx2[15];
acadoWorkspace.H[72] += + Gx1[2]*Gx2[0] + Gx1[6]*Gx2[4] + Gx1[10]*Gx2[8] + Gx1[14]*Gx2[12];
acadoWorkspace.H[73] += + Gx1[2]*Gx2[1] + Gx1[6]*Gx2[5] + Gx1[10]*Gx2[9] + Gx1[14]*Gx2[13];
acadoWorkspace.H[74] += + Gx1[2]*Gx2[2] + Gx1[6]*Gx2[6] + Gx1[10]*Gx2[10] + Gx1[14]*Gx2[14];
acadoWorkspace.H[75] += + Gx1[2]*Gx2[3] + Gx1[6]*Gx2[7] + Gx1[10]*Gx2[11] + Gx1[14]*Gx2[15];
acadoWorkspace.H[108] += + Gx1[3]*Gx2[0] + Gx1[7]*Gx2[4] + Gx1[11]*Gx2[8] + Gx1[15]*Gx2[12];
acadoWorkspace.H[109] += + Gx1[3]*Gx2[1] + Gx1[7]*Gx2[5] + Gx1[11]*Gx2[9] + Gx1[15]*Gx2[13];
acadoWorkspace.H[110] += + Gx1[3]*Gx2[2] + Gx1[7]*Gx2[6] + Gx1[11]*Gx2[10] + Gx1[15]*Gx2[14];
acadoWorkspace.H[111] += + Gx1[3]*Gx2[3] + Gx1[7]*Gx2[7] + Gx1[11]*Gx2[11] + Gx1[15]*Gx2[15];
}
...
A01[36] = + Hx[4]*Gx[0] + Hx[5]*Gx[4] + Hx[6]*Gx[8] + Hx[7]*Gx[12];
A01[37] = + Hx[4]*Gx[1] + Hx[5]*Gx[5] + Hx[6]*Gx[9] + Hx[7]*Gx[13];
A01[38] = + Hx[4]*Gx[2] + Hx[5]*Gx[6] + Hx[6]*Gx[10] + Hx[7]*Gx[14];
A01[39] = + Hx[4]*Gx[3] + Hx[5]*Gx[7] + Hx[6]*Gx[11] + Hx[7]*Gx[15];
}

void acado_multHxE( real_t* const Hx, real_t* const E, int row, int col )
{
acadoWorkspace.A[(row * 72 + 1152) + (col + 4)] = + Hx[0]*E[0] + Hx[1]*E[1] + Hx[2]*E[2] + Hx[3]*E[3];
acadoWorkspace.A[(row * 72 + 1188) + (col + 4)] = + Hx[4]*E[0] + Hx[5]*E[1] + Hx[6]*E[2] + Hx[7]*E[3];
}
...
for (lRun3 = 0;lRun3 < 32; ++lRun3)
acadoWorkspace.H[(lRun2 * 36) + (lRun3 + 4)] = acadoWorkspace.H10[(lRun3 * 4) + (lRun2)];
...
acadoWorkspace.H[(lRun2 * 36 + 144) + (lRun3)] = acadoWorkspace.H10[(lRun2 * 4) + (lRun3)];
...
lRun4 = ((lRun3) / (4)) + (1);
acadoWorkspace.A[lRun1 * 36] = acadoWorkspace.evGx[lRun3 * 4];
acadoWorkspace.A[lRun1 * 36 + 1] = acadoWorkspace.evGx[lRun3 * 4 + 1];
acadoWorkspace.A[lRun1 * 36 + 2] = acadoWorkspace.evGx[lRun3 * 4 + 2];
acadoWorkspace.A[lRun1 * 36 + 3] = acadoWorkspace.evGx[lRun3 * 4 + 3];
for (lRun2 = 0; lRun2 < lRun4; ++lRun2)
{
lRun5 = (((((lRun4) * (lRun4-1)) / (2)) + (lRun2)) * (4)) + ((lRun3) % (4));
acadoWorkspace.A[(lRun1 * 36) + (lRun2 + 4)] = acadoWorkspace.E[lRun5];
}
}
...
acadoWorkspace.A[1152] = acadoWorkspace.evHx[0];
acadoWorkspace.A[1153] = acadoWorkspace.evHx[1];
acadoWorkspace.A[1154] = acadoWorkspace.evHx[2];
acadoWorkspace.A[1155] = acadoWorkspace.evHx[3];
acadoWorkspace.A[1188] = acadoWorkspace.evHx[4];
acadoWorkspace.A[1189] = acadoWorkspace.evHx[5];
acadoWorkspace.A[1190] = acadoWorkspace.evHx[6];
acadoWorkspace.A[1191] = acadoWorkspace.evHx[7];

acado_multHxC( &(acadoWorkspace.evHx[ 8 ]), acadoWorkspace.evGx, &(acadoWorkspace.A[ 1224 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 16 ]), &(acadoWorkspace.evGx[ 16 ]), &(acadoWorkspace.A[ 1296 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 24 ]), &(acadoWorkspace.evGx[ 32 ]), &(acadoWorkspace.A[ 1368 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 32 ]), &(acadoWorkspace.evGx[ 48 ]), &(acadoWorkspace.A[ 1440 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 40 ]), &(acadoWorkspace.evGx[ 64 ]), &(acadoWorkspace.A[ 1512 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 48 ]), &(acadoWorkspace.evGx[ 80 ]), &(acadoWorkspace.A[ 1584 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 56 ]), &(acadoWorkspace.evGx[ 96 ]), &(acadoWorkspace.A[ 1656 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 64 ]), &(acadoWorkspace.evGx[ 112 ]), &(acadoWorkspace.A[ 1728 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 72 ]), &(acadoWorkspace.evGx[ 128 ]), &(acadoWorkspace.A[ 1800 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 80 ]), &(acadoWorkspace.evGx[ 144 ]), &(acadoWorkspace.A[ 1872 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 88 ]), &(acadoWorkspace.evGx[ 160 ]), &(acadoWorkspace.A[ 1944 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 96 ]), &(acadoWorkspace.evGx[ 176 ]), &(acadoWorkspace.A[ 2016 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 104 ]), &(acadoWorkspace.evGx[ 192 ]), &(acadoWorkspace.A[ 2088 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 112 ]), &(acadoWorkspace.evGx[ 208 ]), &(acadoWorkspace.A[ 2160 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 120 ]), &(acadoWorkspace.evGx[ 224 ]), &(acadoWorkspace.A[ 2232 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 128 ]), &(acadoWorkspace.evGx[ 240 ]), &(acadoWorkspace.A[ 2304 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 136 ]), &(acadoWorkspace.evGx[ 256 ]), &(acadoWorkspace.A[ 2376 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 144 ]), &(acadoWorkspace.evGx[ 272 ]), &(acadoWorkspace.A[ 2448 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 152 ]), &(acadoWorkspace.evGx[ 288 ]), &(acadoWorkspace.A[ 2520 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 160 ]), &(acadoWorkspace.evGx[ 304 ]), &(acadoWorkspace.A[ 2592 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 168 ]), &(acadoWorkspace.evGx[ 320 ]), &(acadoWorkspace.A[ 2664 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 176 ]), &(acadoWorkspace.evGx[ 336 ]), &(acadoWorkspace.A[ 2736 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 184 ]), &(acadoWorkspace.evGx[ 352 ]), &(acadoWorkspace.A[ 2808 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 192 ]), &(acadoWorkspace.evGx[ 368 ]), &(acadoWorkspace.A[ 2880 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 200 ]), &(acadoWorkspace.evGx[ 384 ]), &(acadoWorkspace.A[ 2952 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 208 ]), &(acadoWorkspace.evGx[ 400 ]), &(acadoWorkspace.A[ 3024 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 216 ]), &(acadoWorkspace.evGx[ 416 ]), &(acadoWorkspace.A[ 3096 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 224 ]), &(acadoWorkspace.evGx[ 432 ]), &(acadoWorkspace.A[ 3168 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 232 ]), &(acadoWorkspace.evGx[ 448 ]), &(acadoWorkspace.A[ 3240 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 240 ]), &(acadoWorkspace.evGx[ 464 ]), &(acadoWorkspace.A[ 3312 ]) );
acado_multHxC( &(acadoWorkspace.evHx[ 248 ]), &(acadoWorkspace.evGx[ 480 ]), &(acadoWorkspace.A[ 3384 ]) );
...
lRun5 = lRun2 + 1;
acado_multHxE( &(acadoWorkspace.evHx[ lRun2 * 8 + 8 ]), &(acadoWorkspace.E[ lRun4 * 4 ]), lRun5, lRun3 );
}
}

acadoWorkspace.A[1156] = acadoWorkspace.evHu[0];
acadoWorkspace.A[1192] = acadoWorkspace.evHu[1];
acadoWorkspace.A[1229] = acadoWorkspace.evHu[2];
acadoWorkspace.A[1265] = acadoWorkspace.evHu[3];
acadoWorkspace.A[1302] = acadoWorkspace.evHu[4];
acadoWorkspace.A[1338] = acadoWorkspace.evHu[5];
acadoWorkspace.A[1375] = acadoWorkspace.evHu[6];
acadoWorkspace.A[1411] = acadoWorkspace.evHu[7];
acadoWorkspace.A[1448] = acadoWorkspace.evHu[8];
acadoWorkspace.A[1484] = acadoWorkspace.evHu[9];
acadoWorkspace.A[1521] = acadoWorkspace.evHu[10];
acadoWorkspace.A[1557] = acadoWorkspace.evHu[11];
acadoWorkspace.A[1594] = acadoWorkspace.evHu[12];
acadoWorkspace.A[1630] = acadoWorkspace.evHu[13];
acadoWorkspace.A[1667] = acadoWorkspace.evHu[14];
acadoWorkspace.A[1703] = acadoWorkspace.evHu[15];
acadoWorkspace.A[1740] = acadoWorkspace.evHu[16];
acadoWorkspace.A[1776] = acadoWorkspace.evHu[17];
acadoWorkspace.A[1813] = acadoWorkspace.evHu[18];
acadoWorkspace.A[1849] = acadoWorkspace.evHu[19];
acadoWorkspace.A[1886] = acadoWorkspace.evHu[20];
acadoWorkspace.A[1922] = acadoWorkspace.evHu[21];
acadoWorkspace.A[1959] = acadoWorkspace.evHu[22];
acadoWorkspace.A[1995] = acadoWorkspace.evHu[23];
acadoWorkspace.A[2032] = acadoWorkspace.evHu[24];
acadoWorkspace.A[2068] = acadoWorkspace.evHu[25];
acadoWorkspace.A[2105] = acadoWorkspace.evHu[26];
acadoWorkspace.A[2141] = acadoWorkspace.evHu[27];
acadoWorkspace.A[2178] = acadoWorkspace.evHu[28];
acadoWorkspace.A[2214] = acadoWorkspace.evHu[29];
acadoWorkspace.A[2251] = acadoWorkspace.evHu[30];
acadoWorkspace.A[2287] = acadoWorkspace.evHu[31];
acadoWorkspace.A[2324] = acadoWorkspace.evHu[32];
acadoWorkspace.A[2360] = acadoWorkspace.evHu[33];
acadoWorkspace.A[2397] = acadoWorkspace.evHu[34];
acadoWorkspace.A[2433] = acadoWorkspace.evHu[35];
acadoWorkspace.A[2470] = acadoWorkspace.evHu[36];
acadoWorkspace.A[2506] = acadoWorkspace.evHu[37];
acadoWorkspace.A[2543] = acadoWorkspace.evHu[38];
acadoWorkspace.A[2579] = acadoWorkspace.evHu[39];
acadoWorkspace.A[2616] = acadoWorkspace.evHu[40];
acadoWorkspace.A[2652] = acadoWorkspace.evHu[41];
acadoWorkspace.A[2689] = acadoWorkspace.evHu[42];
acadoWorkspace.A[2725] = acadoWorkspace.evHu[43];
acadoWorkspace.A[2762] = acadoWorkspace.evHu[44];
acadoWorkspace.A[2798] = acadoWorkspace.evHu[45];
acadoWorkspace.A[2835] = acadoWorkspace.evHu[46];
acadoWorkspace.A[2871] = acadoWorkspace.evHu[47];
acadoWorkspace.A[2908] = acadoWorkspace.evHu[48];
acadoWorkspace.A[2944] = acadoWorkspace.evHu[49];
acadoWorkspace.A[2981] = acadoWorkspace.evHu[50];
acadoWorkspace.A[3017] = acadoWorkspace.evHu[51];
acadoWorkspace.A[3054] = acadoWorkspace.evHu[52];
acadoWorkspace.A[3090] = acadoWorkspace.evHu[53];
acadoWorkspace.A[3127] = acadoWorkspace.evHu[54];
acadoWorkspace.A[3163] = acadoWorkspace.evHu[55];
acadoWorkspace.A[3200] = acadoWorkspace.evHu[56];
acadoWorkspace.A[3236] = acadoWorkspace.evHu[57];
acadoWorkspace.A[3273] = acadoWorkspace.evHu[58];
acadoWorkspace.A[3309] = acadoWorkspace.evHu[59];
acadoWorkspace.A[3346] = acadoWorkspace.evHu[60];
acadoWorkspace.A[3382] = acadoWorkspace.evHu[61];
acadoWorkspace.A[3419] = acadoWorkspace.evHu[62];
acadoWorkspace.A[3455] = acadoWorkspace.evHu[63];
...
acado_multRDy( &(acadoWorkspace.R2[ 80 ]), &(acadoWorkspace.Dy[ 80 ]), &(acadoWorkspace.g[ 24 ]) );
acado_multRDy( &(acadoWorkspace.R2[ 84 ]), &(acadoWorkspace.Dy[ 84 ]), &(acadoWorkspace.g[ 25 ]) );
acado_multRDy( &(acadoWorkspace.R2[ 88 ]), &(acadoWorkspace.Dy[ 88 ]), &(acadoWorkspace.g[ 26 ]) );
acado_multRDy( &(acadoWorkspace.R2[ 92 ]), &(acadoWorkspace.Dy[ 92 ]), &(acadoWorkspace.g[ 27 ]) );
acado_multRDy( &(acadoWorkspace.R2[ 96 ]), &(acadoWorkspace.Dy[ 96 ]), &(acadoWorkspace.g[ 28 ]) );
acado_multRDy( &(acadoWorkspace.R2[ 100 ]), &(acadoWorkspace.Dy[ 100 ]), &(acadoWorkspace.g[ 29 ]) );
acado_multRDy( &(acadoWorkspace.R2[ 104 ]), &(acadoWorkspace.Dy[ 104 ]), &(acadoWorkspace.g[ 30 ]) );
acado_multRDy( &(acadoWorkspace.R2[ 108 ]), &(acadoWorkspace.Dy[ 108 ]), &(acadoWorkspace.g[ 31 ]) );
acado_multRDy( &(acadoWorkspace.R2[ 112 ]), &(acadoWorkspace.Dy[ 112 ]), &(acadoWorkspace.g[ 32 ]) );
acado_multRDy( &(acadoWorkspace.R2[ 116 ]), &(acadoWorkspace.Dy[ 116 ]), &(acadoWorkspace.g[ 33 ]) );
acado_multRDy( &(acadoWorkspace.R2[ 120 ]), &(acadoWorkspace.Dy[ 120 ]), &(acadoWorkspace.g[ 34 ]) );
acado_multRDy( &(acadoWorkspace.R2[ 124 ]), &(acadoWorkspace.Dy[ 124 ]), &(acadoWorkspace.g[ 35 ]) );
...
{
acadoWorkspace.state[24] = acadoVariables.u[31];
}
acadoWorkspace.state[25] = acadoVariables.od[64];
acadoWorkspace.state[26] = acadoVariables.od[65];
...
kkt = + acadoWorkspace.g[0]*acadoWorkspace.x[0] + acadoWorkspace.g[1]*acadoWorkspace.x[1] + acadoWorkspace.g[2]*acadoWorkspace.x[2] + acadoWorkspace.g[3]*acadoWorkspace.x[3] + acadoWorkspace.g[4]*acadoWorkspace.x[4] + acadoWorkspace.g[5]*acadoWorkspace.x[5] + acadoWorkspace.g[6]*acadoWorkspace.x[6] + acadoWorkspace.g[7]*acadoWorkspace.x[7] + acadoWorkspace.g[8]*acadoWorkspace.x[8] + acadoWorkspace.g[9]*acadoWorkspace.x[9] + acadoWorkspace.g[10]*acadoWorkspace.x[10] + acadoWorkspace.g[11]*acadoWorkspace.x[11] + acadoWorkspace.g[12]*acadoWorkspace.x[12] + acadoWorkspace.g[13]*acadoWorkspace.x[13] + acadoWorkspace.g[14]*acadoWorkspace.x[14] + acadoWorkspace.g[15]*acadoWorkspace.x[15] + acadoWorkspace.g[16]*acadoWorkspace.x[16] + acadoWorkspace.g[17]*acadoWorkspace.x[17] + acadoWorkspace.g[18]*acadoWorkspace.x[18] + acadoWorkspace.g[19]*acadoWorkspace.x[19] + acadoWorkspace.g[20]*acadoWorkspace.x[20] + acadoWorkspace.g[21]*acadoWorkspace.x[21] + acadoWorkspace.g[22]*acadoWorkspace.x[22] + acadoWorkspace.g[23]*acadoWorkspace.x[23] + acadoWorkspace.g[24]*acadoWorkspace.x[24] + acadoWorkspace.g[25]*acadoWorkspace.x[25] + acadoWorkspace.g[26]*acadoWorkspace.x[26] + acadoWorkspace.g[27]*acadoWorkspace.x[27] + acadoWorkspace.g[28]*acadoWorkspace.x[28] + acadoWorkspace.g[29]*acadoWorkspace.x[29] + acadoWorkspace.g[30]*acadoWorkspace.x[30] + acadoWorkspace.g[31]*acadoWorkspace.x[31] + acadoWorkspace.g[32]*acadoWorkspace.x[32] + acadoWorkspace.g[33]*acadoWorkspace.x[33] + acadoWorkspace.g[34]*acadoWorkspace.x[34] + acadoWorkspace.g[35]*acadoWorkspace.x[35];
kkt = fabs( kkt );
