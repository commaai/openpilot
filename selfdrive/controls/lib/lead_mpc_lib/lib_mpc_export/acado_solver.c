...
out[29] = ((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00));
out[30] = (((real_t)(0.0000000000000000e+00)-(((xd[1]/(real_t)(7.0000000000000000e+00))+(xd[1]*a[2]))-(((((real_t)(7.0000000000000000e+00)*a[3])*(xd[1]/(real_t)(7.0000000000000000e+00)))+(((real_t)(7.0000000000000000e+00)*(xd[1]/(real_t)(7.0000000000000000e+00)))*a[4]))*a[5])))-(real_t)(1.8000000000000000e+00));
...
{
tmpR2[0] = + tmpFu[0]*tmpObjS[0] + tmpFu[4]*tmpObjS[5] + tmpFu[8]*tmpObjS[10] + tmpFu[12]*tmpObjS[15] + tmpFu[16]*tmpObjS[20];
tmpR2[1] = + tmpFu[0]*tmpObjS[1] + tmpFu[4]*tmpObjS[6] + tmpFu[8]*tmpObjS[11] + tmpFu[12]*tmpObjS[16] + tmpFu[16]*tmpObjS[21];
tmpR2[2] = + tmpFu[0]*tmpObjS[2] + tmpFu[4]*tmpObjS[7] + tmpFu[8]*tmpObjS[12] + tmpFu[12]*tmpObjS[17] + tmpFu[16]*tmpObjS[22];
tmpR2[3] = + tmpFu[0]*tmpObjS[3] + tmpFu[4]*tmpObjS[8] + tmpFu[8]*tmpObjS[13] + tmpFu[12]*tmpObjS[18] + tmpFu[16]*tmpObjS[23];
tmpR2[4] = + tmpFu[0]*tmpObjS[4] + tmpFu[4]*tmpObjS[9] + tmpFu[8]*tmpObjS[14] + tmpFu[12]*tmpObjS[19] + tmpFu[16]*tmpObjS[24];
tmpR2[5] = + tmpFu[1]*tmpObjS[0] + tmpFu[5]*tmpObjS[5] + tmpFu[9]*tmpObjS[10] + tmpFu[13]*tmpObjS[15] + tmpFu[17]*tmpObjS[20];
tmpR2[6] = + tmpFu[1]*tmpObjS[1] + tmpFu[5]*tmpObjS[6] + tmpFu[9]*tmpObjS[11] + tmpFu[13]*tmpObjS[16] + tmpFu[17]*tmpObjS[21];
tmpR2[7] = + tmpFu[1]*tmpObjS[2] + tmpFu[5]*tmpObjS[7] + tmpFu[9]*tmpObjS[12] + tmpFu[13]*tmpObjS[17] + tmpFu[17]*tmpObjS[22];
tmpR2[8] = + tmpFu[1]*tmpObjS[3] + tmpFu[5]*tmpObjS[8] + tmpFu[9]*tmpObjS[13] + tmpFu[13]*tmpObjS[18] + tmpFu[17]*tmpObjS[23];
tmpR2[9] = + tmpFu[1]*tmpObjS[4] + tmpFu[5]*tmpObjS[9] + tmpFu[9]*tmpObjS[14] + tmpFu[13]*tmpObjS[19] + tmpFu[17]*tmpObjS[24];
tmpR2[10] = + tmpFu[2]*tmpObjS[0] + tmpFu[6]*tmpObjS[5] + tmpFu[10]*tmpObjS[10] + tmpFu[14]*tmpObjS[15] + tmpFu[18]*tmpObjS[20];
tmpR2[11] = + tmpFu[2]*tmpObjS[1] + tmpFu[6]*tmpObjS[6] + tmpFu[10]*tmpObjS[11] + tmpFu[14]*tmpObjS[16] + tmpFu[18]*tmpObjS[21];
tmpR2[12] = + tmpFu[2]*tmpObjS[2] + tmpFu[6]*tmpObjS[7] + tmpFu[10]*tmpObjS[12] + tmpFu[14]*tmpObjS[17] + tmpFu[18]*tmpObjS[22];
tmpR2[13] = + tmpFu[2]*tmpObjS[3] + tmpFu[6]*tmpObjS[8] + tmpFu[10]*tmpObjS[13] + tmpFu[14]*tmpObjS[18] + tmpFu[18]*tmpObjS[23];
tmpR2[14] = + tmpFu[2]*tmpObjS[4] + tmpFu[6]*tmpObjS[9] + tmpFu[10]*tmpObjS[14] + tmpFu[14]*tmpObjS[19] + tmpFu[18]*tmpObjS[24];
tmpR2[15] = + tmpFu[3]*tmpObjS[0] + tmpFu[7]*tmpObjS[5] + tmpFu[11]*tmpObjS[10] + tmpFu[15]*tmpObjS[15] + tmpFu[19]*tmpObjS[20];
tmpR2[16] = + tmpFu[3]*tmpObjS[1] + tmpFu[7]*tmpObjS[6] + tmpFu[11]*tmpObjS[11] + tmpFu[15]*tmpObjS[16] + tmpFu[19]*tmpObjS[21];
tmpR2[17] = + tmpFu[3]*tmpObjS[2] + tmpFu[7]*tmpObjS[7] + tmpFu[11]*tmpObjS[12] + tmpFu[15]*tmpObjS[17] + tmpFu[19]*tmpObjS[22];
tmpR2[18] = + tmpFu[3]*tmpObjS[3] + tmpFu[7]*tmpObjS[8] + tmpFu[11]*tmpObjS[13] + tmpFu[15]*tmpObjS[18] + tmpFu[19]*tmpObjS[23];
tmpR2[19] = + tmpFu[3]*tmpObjS[4] + tmpFu[7]*tmpObjS[9] + tmpFu[11]*tmpObjS[14] + tmpFu[15]*tmpObjS[19] + tmpFu[19]*tmpObjS[24];
tmpR1[0] = + tmpR2[0]*tmpFu[0] + tmpR2[1]*tmpFu[4] + tmpR2[2]*tmpFu[8] + tmpR2[3]*tmpFu[12] + tmpR2[4]*tmpFu[16];
tmpR1[1] = + tmpR2[0]*tmpFu[1] + tmpR2[1]*tmpFu[5] + tmpR2[2]*tmpFu[9] + tmpR2[3]*tmpFu[13] + tmpR2[4]*tmpFu[17];
tmpR1[2] = + tmpR2[0]*tmpFu[2] + tmpR2[1]*tmpFu[6] + tmpR2[2]*tmpFu[10] + tmpR2[3]*tmpFu[14] + tmpR2[4]*tmpFu[18];
tmpR1[3] = + tmpR2[0]*tmpFu[3] + tmpR2[1]*tmpFu[7] + tmpR2[2]*tmpFu[11] + tmpR2[3]*tmpFu[15] + tmpR2[4]*tmpFu[19];
tmpR1[4] = + tmpR2[5]*tmpFu[0] + tmpR2[6]*tmpFu[4] + tmpR2[7]*tmpFu[8] + tmpR2[8]*tmpFu[12] + tmpR2[9]*tmpFu[16];
tmpR1[5] = + tmpR2[5]*tmpFu[1] + tmpR2[6]*tmpFu[5] + tmpR2[7]*tmpFu[9] + tmpR2[8]*tmpFu[13] + tmpR2[9]*tmpFu[17];
tmpR1[6] = + tmpR2[5]*tmpFu[2] + tmpR2[6]*tmpFu[6] + tmpR2[7]*tmpFu[10] + tmpR2[8]*tmpFu[14] + tmpR2[9]*tmpFu[18];
tmpR1[7] = + tmpR2[5]*tmpFu[3] + tmpR2[6]*tmpFu[7] + tmpR2[7]*tmpFu[11] + tmpR2[8]*tmpFu[15] + tmpR2[9]*tmpFu[19];
tmpR1[8] = + tmpR2[10]*tmpFu[0] + tmpR2[11]*tmpFu[4] + tmpR2[12]*tmpFu[8] + tmpR2[13]*tmpFu[12] + tmpR2[14]*tmpFu[16];
tmpR1[9] = + tmpR2[10]*tmpFu[1] + tmpR2[11]*tmpFu[5] + tmpR2[12]*tmpFu[9] + tmpR2[13]*tmpFu[13] + tmpR2[14]*tmpFu[17];
tmpR1[10] = + tmpR2[10]*tmpFu[2] + tmpR2[11]*tmpFu[6] + tmpR2[12]*tmpFu[10] + tmpR2[13]*tmpFu[14] + tmpR2[14]*tmpFu[18];
tmpR1[11] = + tmpR2[10]*tmpFu[3] + tmpR2[11]*tmpFu[7] + tmpR2[12]*tmpFu[11] + tmpR2[13]*tmpFu[15] + tmpR2[14]*tmpFu[19];
tmpR1[12] = + tmpR2[15]*tmpFu[0] + tmpR2[16]*tmpFu[4] + tmpR2[17]*tmpFu[8] + tmpR2[18]*tmpFu[12] + tmpR2[19]*tmpFu[16];
tmpR1[13] = + tmpR2[15]*tmpFu[1] + tmpR2[16]*tmpFu[5] + tmpR2[17]*tmpFu[9] + tmpR2[18]*tmpFu[13] + tmpR2[19]*tmpFu[17];
tmpR1[14] = + tmpR2[15]*tmpFu[2] + tmpR2[16]*tmpFu[6] + tmpR2[17]*tmpFu[10] + tmpR2[18]*tmpFu[14] + tmpR2[19]*tmpFu[18];
tmpR1[15] = + tmpR2[15]*tmpFu[3] + tmpR2[16]*tmpFu[7] + tmpR2[17]*tmpFu[11] + tmpR2[18]*tmpFu[15] + tmpR2[19]*tmpFu[19];
}
...
acado_setObjR1R2( &(acadoWorkspace.objValueOut[ 35 ]), &(acadoVariables.W[ runObj * 25 ]), &(acadoWorkspace.R1[ runObj * 16 ]), &(acadoWorkspace.R2[ runObj * 20 ]) );
...
a[14] = ((real_t)(1.0000000000000000e+00)/(real_t)(7.0000000000000000e+00));
a[15] = (a[14]*xd[1]);
a[16] = (a[13]+a[15]);
a[17] = ((real_t)(1.0000000000000000e+00)/(real_t)(7.0000000000000000e+00));
a[18] = (real_t)(7.0000000000000000e+00);
a[19] = (a[17]*a[18]);
a[20] = (xd[1]/(real_t)(7.0000000000000000e+00));
a[21] = (a[19]*a[20]);
a[22] = ((real_t)(1.0000000000000000e+00)/(real_t)(7.0000000000000000e+00));
a[23] = ((real_t)(7.0000000000000000e+00)*(xd[1]/(real_t)(7.0000000000000000e+00)));
a[24] = (a[22]*a[23]);
a[25] = ((real_t)(1.0000000000000000e+00)/(real_t)(2.0000000000000000e+00));
a[26] = ((a[21]+a[24])*a[25]);
a[27] = (real_t)(-1.0000000000000000e+00);
a[28] = (a[26]*a[27]);
a[29] = (real_t)(-1.0000000000000000e+00);
a[30] = ((a[16]+a[28])*a[29]);
a[31] = (real_t)(1.8000000000000000e+00);
