...
_AWARENESS_PRE_TIME = 200.   # a first alert is issued 200s before expiration
_AWARENESS_PROMPT_TIME = 50. # a second alert is issued 50s before start decelerating the car
_DISTRACTED_TIME = 60.
