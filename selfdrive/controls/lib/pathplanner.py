...
class PathPlanner():
  def __init__(self, CP):
    ...
    self.steer_rate_cost = 5 * CP.steerRateCost
  ...
  def setup_mpc(self):
    ...
    self.libmpc.init(MPC_COST_LAT.PATH, self.steer_rate_cost)
  ...
  def update(self, sm, pm, CP, VM):
    ...
    if desire == log.PathPlan.Desire.laneChangeRight or desire == log.PathPlan.Desire.laneChangeLeft:
      ...
      self.libmpc.init_weights(MPC_COST_LAT.PATH / 3.0, self.steer_rate_cost)
    else:
      self.libmpc.init_weights(MPC_COST_LAT.PATH, self.steer_rate_cost)
