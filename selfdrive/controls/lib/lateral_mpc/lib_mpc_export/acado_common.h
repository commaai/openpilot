 ...
 * 
 *  Matrix containing 15 reference/measurement vectors of size 3 for first 15 nodes.
 */
real_t y[ 45 ];
...
/** Matrix of size: 45 x 3 (row major format) */
real_t W[ 135 ];
...
/** Matrix of size: 15 x 19 (row major format) */
real_t A[ 285 ];
