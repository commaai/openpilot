...
acadoWorkspace.objValueIn[8] = acadoVariables.od[124];
acadoWorkspace.objValueIn[9] = acadoVariables.od[125];
...
acadoWorkspace.state[29] = acadoVariables.od[124];
acadoWorkspace.state[30] = acadoVariables.od[125];
