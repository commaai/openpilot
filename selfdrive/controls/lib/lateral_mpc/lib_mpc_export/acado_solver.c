...
/* Compute outputs: */
out[0] = ((xd[1]*xd[1])*xd[1]);
out[1] = ((od[0]+(real_t)(1.0000000000000000e+00))*xd[2]);
out[2] = (((od[0]+(real_t)(1.0000000000000000e+00))*(real_t)(5.0000000000000000e+00))*u[0]);
out[3] = (real_t)(0.0000000000000000e+00);
out[4] = (((xd[1]+xd[1])*xd[1])+(xd[1]*xd[1]));
...
out[17] = ((od[0]+(real_t)(1.0000000000000000e+00))*(real_t)(5.0000000000000000e+00));
}
...
out[3] = (((xd[1]+xd[1])*xd[1])+(xd[1]*xd[1]));
