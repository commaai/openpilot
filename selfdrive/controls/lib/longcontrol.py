  ...
  def dynamic_gas(self, v_ego, v_rel, d_rel, gasinterceptor, gasbuttonstatus):
    ...
    if gasinterceptor:
      if gasbuttonstatus == 0:
        ...
        x = [0.0, 3.15006, 6.27037, 9.45465, 12.04078, 13.79208, 16.21289, 18.528711170501101, 22.916628030302903, 28.99969, 34.50033, 40.53112, 45.00052, 54.7292, 65.001, 73.17053, 80.00013]
        y = [0.2, 0.20443, 0.21592, 0.23334, 0.25734, 0.27916, 0.3229, 0.34783614203257063, 0.36764520202020201, 0.38, 0.396, 0.409, 0.425, 0.478, 0.55, 0.621, 0.7]
