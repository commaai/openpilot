  ...
  def dynamic_gas(self, v_ego, v_rel, d_rel, gasinterceptor, gasbuttonstatus):
    ...
    if gasinterceptor:
      if gasbuttonstatus == 0:
        ...
        x = [0.0, 1.40822, 2.80312, 4.22663, 5.38272, 6.16562, 6.89779, 7.36051, 8.11676, 9.3878, 10.88714, 12.96403,
             15.42301, 18.0172, 20.11702, 24.46614, 29.05805, 32.71014, 35.7632]  # velocity/gasMaxBP
        y = [0.2, 0.21031, 0.22876, 0.25516, 0.2891, 0.3196, 0.3526, 0.37986, 0.40577, 0.43303, 0.4497, 0.46075,
             0.47107, 0.47771, 0.48698, 0.521, 0.58437, 0.63867, 0.7]  # accel values/gasMaxV
