...
class LongControl():
  ...
  def update(self, active, CS, CP, long_plan):
    ...
    # tracking objects and driving
      ...
      output_gb = self.pid.update(self.v_pid, v_ego_pid, speed=v_ego_pid, deadzone=deadzone, feedforward=a_target, freeze_integrator=prevent_overshoot, neg_extra=True)
