...
class LongControl(object):
  ...
  def update(self, active, v_ego, brake_pressed, standstill, cruise_standstill, v_cruise, v_target, v_target_future, a_target, CP, force_decel, longitudinalPlanSource):
