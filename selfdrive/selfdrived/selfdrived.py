...
class SelfdriveD:
  ...
  def publish_selfdriveState(self, CS):
    ...
    ss.alertFastForward = self.AM.current_alert.fast_forward
    ss.alertDuration = self.AM.current_alert.duration
    ss.alertProgressDuration = self.AM.current_alert.progress_duration
