...
EVENTS: dict[int, dict[str, Alert | AlertCallbackType]] = {
  ...
  EventName.canError: {
    ET.IMMEDIATE_DISABLE: ImmediateDisableAlert("Unexpected CAN Configuration"),
    ET.PERMANENT: Alert(
      "Unexpected CAN Configuration",
      "",
      AlertStatus.normal, AlertSize.small,
      Priority.LOW, VisualAlert.none, AudibleAlert.none, 1., creation_delay=1.),
    ET.NO_ENTRY: NoEntryAlert("Unexpected CAN Configuration"),
  },
