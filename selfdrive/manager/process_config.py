...
procs = [
  ...
  NativeProcess("navd", "selfdrive/ui/navd", ["./navd"], offroad=True,enabled=False),
  NativeProcess("proclogd", "selfdrive/proclogd", ["./proclogd"]),
  NativeProcess("sensord", "selfdrive/sensord", ["./sensord"],enabled=False),
  ...
  PythonProcess("logmessaged", "selfdrive.logmessaged", offroad=False),
