...
struct i2c_random_wr_payload init_array_ar0231[] = {
  ...
  // HDR Settings
  {0x3082, 0x0004}, // OPERATION_MODE_CTRL (A) (enable HDR + 2 exposures)
  ...
  {0x33DA, 0x0000}, // OC_LUT_CONTROL - disable OC_LEGACY_COMPANDING
  {0x33C0, 0x2000}, // OC_LUT_00
  {0x33C2, 0x3440}, // OC_LUT_01
  {0x33C4, 0x4890}, // OC_LUT_02
  {0x33C6, 0x5CE0}, // OC_LUT_03
  {0x33C8, 0x7140}, // OC_LUT_04
  {0x33CA, 0x8590}, // OC_LUT_05
  {0x33CC, 0x99E0}, // OC_LUT_06
  {0x33CE, 0xAE40}, // OC_LUT_07
  {0x33D0, 0xC290}, // OC_LUT_08
  {0x33D2, 0xD6F0}, // OC_LUT_09
  {0x33D4, 0xEB40}, // OC_LUT_10
  {0x33D6, 0x0000}, // OC_LUT_11
