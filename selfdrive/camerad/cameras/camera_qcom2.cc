...
void cameras_init(VisionIpcServer *v, MultiCameraState *s, cl_device_id device_id, cl_context ctx) {
  ...
  s->pm = new PubMaster({"frame", "driverCameraState", "wideRoadCameraState", "thumbnail"});
}
...
void camera_process_frame(MultiCameraState *s, CameraState *c, int cnt) {
  ...
  MessageBuilder msg;
  auto framed = c == &s->rear ? msg.initEvent().initFrame() : msg.initEvent().initWideRoadCameraState();
  ...
  s->pm->send(c == &s->rear ? "frame" : "wideRoadCameraState", msg);
