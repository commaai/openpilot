...
extern const uint8_t str_continue[] asm("_binary_selfdrive_ui_installer_continue_sh_start");
extern const uint8_t str_continue_end[] asm("_binary_selfdrive_ui_installer_continue_sh_end");
