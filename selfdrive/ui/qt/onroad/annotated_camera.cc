...
void AnnotatedCameraWidget::updateFrameMat() {
  ...
  mat3 video_transform = {{
    zoom, 0.0f, (w / 2 - x_offset) - (intrinsic_matrix.v[2] * zoom),
    0.0f, zoom, (h / 2 - y_offset) - (intrinsic_matrix.v[5] * zoom),
    0.0f, 0.0f, 1.0f
  }};
  auto calib_transform = matmul3(intrinsic_matrix, calibration);
  model.setTransform(matmul3(video_transform, calib_transform));
}
