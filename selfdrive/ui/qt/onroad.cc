...
void NvgWindow::drawLaneLines(QPainter &painter, const UIState *s) {
  ...
  if (scene.end_to_end) {
    ...
    bg.setColorAt(0.0, QColor::fromHslF(148 / 360., 0.94, 0.51, 1.0));
    bg.setColorAt(0.75 / 1.5, QColor::fromHslF(curve_hue / 360., 1.0, 0.68, 0.5));
    bg.setColorAt(1.0, QColor::fromHslF(148 / 360., 0.94, 0.51, 0.0));
  } else {
