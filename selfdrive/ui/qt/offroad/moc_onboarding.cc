...
QT_MOC_LITERAL(3, 25, 12) // "enableAccept"

    },
    "TermsPage\0acceptedTerms\0\0enableAccept"
};
#undef QT_MOC_LITERAL
...
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 18), // "resetTrainingGuide"
QT_MOC_LITERAL(4, 52, 18) // "updateActiveScreen"

    },
    "OnboardingWindow\0onboardingDone\0\0"
    "resetTrainingGuide\0updateActiveScreen"
};
#undef QT_MOC_LITERAL
...
void OnboardingWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->resetTrainingGuide(); break;
        case 2: _t->updateActiveScreen(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        ...
        {
            using _t = void (OnboardingWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OnboardingWindow::resetTrainingGuide)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void OnboardingWindow::resetTrainingGuide()
{
