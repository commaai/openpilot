...
void TogglesPanel::updateToggles() {
  ...
  const QString e2e_description = QString("%1<br>"
                                          ...
                                          "<h4>%4</h4><br>"
                                          "%5")
                                  .arg("openpilot defaults to driving in <b>chill mode</b>. Experimental mode enables <b>alpha-level features</b> that aren't ready for chill mode. Experimental features are listed below:")
                                  .arg("🌮 End-to-End Longitudinal Control 🌮")
                                  .arg("Let the driving model control the gas and brakes. openpilot will drive as it thinks a human would, including stopping for red lights and stop signs. "
                                  ...
                                  .arg("New Driving Visualization")
                                  .arg("The driving visualization will transition to the road-facing wide-angle camera at low speeds to better show some turns. The Experimental mode logo will also be shown in the top right corner.");
