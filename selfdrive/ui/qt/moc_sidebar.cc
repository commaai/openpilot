...
static const uint qt_meta_data_Sidebar[] = {
 ...
 // properties: name, type, flags
      ...
      14, QMetaType::QImage, 0x00495003,
...
void Sidebar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 7: *reinterpret_cast< QImage*>(_v) = _t->net_strength; break;
        default: break;
        }
        ...
        case 6:
            ...
            break;
        case 7:
            if (_t->net_strength != *reinterpret_cast< QImage*>(_v)) {
                _t->net_strength = *reinterpret_cast< QImage*>(_v);
                Q_EMIT _t->valueChanged();
            }
            break;
        default: break;
