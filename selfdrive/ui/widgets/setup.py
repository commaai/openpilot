...
class SetupWidget(Widget):
  def __init__(self):
    ...
    self._firehose_label = Label("🔥 Firehose Mode 🔥", font_weight=FontWeight.MEDIUM, font_size=64, text_alignment=rl.GuiTextAlignment.TEXT_ALIGN_CENTER)
  ...
  def _render_firehose_prompt(self, rect: rl.Rectangle):
    ...
    self._firehose_label.set_position(rect.x + rect.width / 2, y)
    self._firehose_label.render()
    y += 64 + spacing
