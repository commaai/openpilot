...
from openpilot.selfdrive.ui.mici.widgets.button import ConfirmationButton
...
class TrainingGuideRecordFront(NavScroller):
  def __init__(self, continue_callback: Callable[[], None]):
    ...
    self._accept_button = ConfirmationButton("icons_mici/setup/driver_monitoring/dm_check.png", "allow data uploading",
                                              exit_on_confirm=False, confirm_callback=on_accept)

    self._decline_button = ConfirmationButton("icons_mici/setup/cancel.png", "no, don't upload",
                                               exit_on_confirm=False, confirm_callback=on_decline)
...
class TermsPage(Scroller):
  def __init__(self, on_accept, on_decline):
    ...
    self._accept_button = ConfirmationButton("icons_mici/setup/driver_monitoring/dm_check.png", "accept\nterms",
                                               confirm_callback=on_accept)

    self._decline_button = ConfirmationButton("icons_mici/setup/cancel.png", "decline &\nuninstall",
