...
class MiciHomeLayout(Widget):
  def __init__(self):
    ...
    self._branch_label_old = MiciLabel("", font_size=36, color=rl.GRAY, font_weight=FontWeight.ROMAN, elide_right=False, scroll=True)
    self._branch_label = UnifiedLabel("", font_size=36, text_color=rl.GRAY, font_weight=FontWeight.ROMAN, elide=False, wrap_text=False, scroll=True)
  ...
  def _render(self, _):
    ...
    if self._version_text is not None:
      ...
      # self._branch_label_old.set_width(gui_app.width - self._version_label.rect.width - self._date_label.rect.width - 32)
      # self._branch_label_old.set_text(" " + ("release" if release_branch else self._version_text[1]))
      # self._branch_label_old.set_position(version_pos.x + self._version_label.rect.width + self._date_label.rect.width + 20, version_pos.y)
      # self._branch_label_old.render()
      ...
      self._branch_label.set_text("this 🤖 is 🏄 a branch!")
      ...
      self._branch_label.render(rl.Rectangle(
        version_pos.x + self._version_label.rect.width + self._date_label.rect.width + 20,
        version_pos.y,
        gui_app.width - self._version_label.rect.width - self._date_label.rect.width - 32,
        36,
      ))
