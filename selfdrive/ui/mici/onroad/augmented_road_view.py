...
class AugmentedRoadView(CameraView):
  ...
  def _render(self, _):
    ...
    if ui_state.started:
      ...
      # Offroad: solid black with label, never show stale camera/overlays
      rl.draw_rectangle(int(self.rect.x), int(self.rect.y), int(self.rect.width), int(self.rect.height), rl.BLACK)
