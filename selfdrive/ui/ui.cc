...
static void update_state(UIState *s) {
  ...
  if (!scene.started && sm.updated("sensorEventsDEPRECATED")) {
    for (auto sensor : sm["sensorEventsDEPRECATED"].getSensorEventsDEPRECATED()) {
...
UIState::UIState(QObject *parent) : QObject(parent) {
  sm = std::make_unique<SubMaster, const std::initializer_list<const char *>>({
    ...
    "pandaStates", "carParams", "driverMonitoringState", "sensorEventsDEPRECATED", "carState", "liveLocationKalman",
