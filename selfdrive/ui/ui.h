...
constexpr mat3 FCAM_INTRINSIC_MATRIX = (mat3){{1522.0 * 0.75, 0.0, 2688.0 / 2 / 2,
                                           0.0, 1522.0 * 0.75, 1520.0 / 2 / 2,
                                           0.0, 0.0, 1.0}};
// tici ecam focal probably wrong? magnification is not consistent across frame
// Need to retrain model before this can be changed
constexpr mat3 ECAM_INTRINSIC_MATRIX = (mat3){{1522.0 * 0.75, 0.0, 2688.0 / 2 / 2,
                                           0.0, 1522.0 * 0.75, 1520.0 / 2 / 2,
                                           0.0, 0.0, 1.0}};
