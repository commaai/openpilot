...
<context>
    ...
    <message>
        ...
        <translation>    openpilot 默认以 &lt;b&gt;轻松模式&lt;/b&gt; 驾驶。    实验模式启用了尚未准备好进入轻松模式的 &lt;b&gt;alpha 级功能&lt;/b&gt;。     实验功能如下：    &lt;br&gt;     &lt;h4&gt;🌮端到端纵向控制🌮&lt;/h4&gt;     让驾驶模型控制油门和刹车。 openpilot 將像人类一样驾驶，包括在紅灯和识别停车标志时停车，因为是由驾驶模型来決定车速，所以定速的设定值只会作为上限。</translation>
    </message>
    <message>
