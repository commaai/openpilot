...
<context>
    ...
    <message>
        ...
        <translation>    openpilot默认驾驶模式为激进模式。   实验模式开启 ;alpha功能; 这是 ;t 准备好进入激进模式。    实验特性如下所示：    ;🌮 端到端纵向控制;     让驾驶模型控制油门和刹车。openpilot将执行它认为的人类驾驶行为，包括在红灯和停车标志时停车。由于驾驶模型决定了驾驶的速度，因此设定的速度仅作为上限</translation>
    </message>
    <message>
