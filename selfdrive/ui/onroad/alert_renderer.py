...
# Constants
ALERT_COLORS = {
  AlertStatus.normal: rl.Color(21, 21, 21, 241),      # #151515 with alpha 0xF1
  AlertStatus.userPrompt: rl.Color(218, 111, 37, 241),  # #DA6F25 with alpha 0xF1
  AlertStatus.critical: rl.Color(201, 34, 49, 241),    # #C92231 with alpha 0xF1
}
