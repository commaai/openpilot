...
class FwQueryConfig:
  ...
  # Function a brand can implement to provide better fuzzy or exact matching or alternative exact matching.
  # Takes in FW versions, VIN, and returns set of candidates. Only will match if one candidate is returned
  match_fw_to_car: Callable[[LiveFwVersions, str, OfflineFwVersions], tuple[bool, set[str]]] | None = None
