...
def get_present_ecus(logcan, sendcan, num_pandas=1) -> Set[EcuAddrBusType]:
  ...
  ecu_responses = set()
  for obd_multiplexing in queries:
    print('OBDOBDOBDOBDOBDOBDOBDOBDOBDOBDOBD - tester present, obd_multiplexing:', obd_multiplexing)
  ...
  for addr in tqdm(addrs, disable=not progress):
    for addr_chunk in chunks(addr):
      for brand, r in requests:
        ...
        print('OBDOBDOBDOBDOBDOBDOBDOBDOBDOBDOBD - setting obd_multiplexing for {} request: {}'.format(brand, r.obd_multiplexing))
