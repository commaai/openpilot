...
SUBARU_VERSION_REQUEST_MULTI = bytes([uds.SERVICE_TYPE.READ_DATA_BY_IDENTIFIER]) + \
  p16(uds.DATA_IDENTIFIER_TYPE.VEHICLE_MANUFACTURER_SPARE_PART_NUMBER) + \
  p16(uds.DATA_IDENTIFIER_TYPE.VEHICLE_MANUFACTURER_ECU_SOFTWARE_VERSION_NUMBER) + \
  p16(uds.DATA_IDENTIFIER_TYPE.APPLICATION_DATA_IDENTIFICATION)
## TODO: verify that version response size accounts for all request data, based on Volkswagen
...
REQUESTS = [
  ...
  # Subaru
  ## TODO: verify why VW had a specific RX offset
  (
    "subaru",
    [SUBARU_VERSION_REQUEST_MULTI],
