...
CHRYSLER_VERSION_REQUEST_ALT = bytes([uds.SERVICE_TYPE.READ_DATA_BY_IDENTIFIER]) + \
  p16(uds.DATA_IDENTIFIER_TYPE.SYSTEM_SUPPLIER_ECU_SOFTWARE_NUMBER)
CHRYSLER_VERSION_RESPONSE_ALT = bytes([uds.SERVICE_TYPE.READ_DATA_BY_IDENTIFIER + 0x40]) + \
  p16(uds.DATA_IDENTIFIER_TYPE.SYSTEM_SUPPLIER_ECU_SOFTWARE_NUMBER)
...
REQUESTS: List[Request] = [
  ...
  Request(
    "chrysler",
    [CHRYSLER_VERSION_REQUEST_ALT],
    [CHRYSLER_VERSION_RESPONSE_ALT],
