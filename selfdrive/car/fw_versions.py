...
NISSAN_KWP_DIAGNOSTIC_REQUEST = bytes([uds.SERVICE_TYPE.DIAGNOSTIC_SESSION_CONTROL, 0xc0])
NISSAN_KWP_DIAGNOSTIC_RESPONSE = bytes([uds.SERVICE_TYPE.DIAGNOSTIC_SESSION_CONTROL + 0x40, 0xc0])
...
REQUESTS = [
  ...
  (
    "nissan",
    [NISSAN_KWP_DIAGNOSTIC_REQUEST, NISSAN_KWP_VERSION_REQUEST],
    [NISSAN_KWP_DIAGNOSTIC_RESPONSE, NISSAN_KWP_VERSION_RESPONSE],
    NISSAN_RX_OFFSET,
  ),
  (
    "nissan",
