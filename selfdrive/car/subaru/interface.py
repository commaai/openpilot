...
from selfdrive.car.subaru.values import CAR, GLOBAL_GEN2, GLOBAL_GEN3, PREGLOBAL_CARS, SubaruFlags
...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret, candidate, fingerprint, car_fw, experimental_long, docs):
    ...
    if candidate in PREGLOBAL_CARS:
      ...
      elif candidate in GLOBAL_GEN3:
        ret.safetyConfigs[0].safetyParam |= Panda.FLAG_SUBARU_GEN3
