...
class CarController:
  ...
  def update(self, CC, CS, now_nanos):
    ...
    if self.CP.carFingerprint in PREGLOBAL_CARS:
      ...
      if self.frame % 10 == 0:
        can_sends.append(subarucan.create_es_dashstatus(self.packer, CS.es_dashstatus_msg, CC.enabled, CC.longActive, brake_cmd, brake_value, hud_control, CS.is_metric, CS.out.cruiseState.available))
