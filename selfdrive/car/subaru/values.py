...
class SubaruCarInfo(CarInfo):
  ...
  car_parts: CarParts = CarParts.default([CarPart.subaru_a])


CAR_INFO: Dict[str, Union[SubaruCarInfo, List[SubaruCarInfo]]] = {
  CAR.ASCENT: SubaruCarInfo("Subaru Ascent 2019-21", "All"),
  CAR.OUTBACK: SubaruCarInfo("Subaru Outback 2020-22", "All", car_parts=CarParts.default([CarPart.subaru_b])),
  CAR.LEGACY: SubaruCarInfo("Subaru Legacy 2020-22", "All", car_parts=CarParts.default([CarPart.subaru_b])),
  CAR.IMPREZA: [
