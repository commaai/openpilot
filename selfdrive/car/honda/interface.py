...
from selfdrive.car import STD_CARGO_KG, ReferenceCarParams, create_button_event, get_safety_config
...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret, candidate, fingerprint, car_fw, experimental_long, docs):
    ...
    if candidate == CAR.CIVIC:
      ret.mass = ReferenceCarParams.MASS
      ret.wheelbase = ReferenceCarParams.WHEELBASE
      ret.centerToFront = ReferenceCarParams.CENTER_TO_FRONT
