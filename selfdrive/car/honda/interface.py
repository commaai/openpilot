...
from selfdrive.car.honda.values import CruiseButtons, CAR, HONDA_BOSCH, MANUAL_TRANSMISSION, AUDIO_HUD, VISUAL_HUD
...
class CarInterface(object):
  ...
  def get_params(candidate, fingerprint):
    ...
    ret.manualTransmission = candidate in MANUAL_TRANSMISSION
    ...
    if candidate in [CAR.CIVIC, CAR.CIVIC_BOSCH, CAR.CIVIC_HATCH_MANUAL_10]:
      stop_and_go = True
      ret.mass = mass_civic
