...
def parse_gear_shifter(can_gear_shifter, is_acura, is_odyssey, is_pilot):
...
class CarState(object):
  ...
  def update(self, cp):
    ...
    self.gear_shifter = parse_gear_shifter(can_gear_shifter, self.acura,  self.odyssey, self.pilot)
