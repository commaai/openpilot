...
class CarState(object):
  ...
  def update(self, cp, cp_cam):
    ...
    if self.CP.carFingerprint in (CAR.CIVIC, CAR.ODYSSEY, CAR.CRV_5G, CAR.ACCORD, CAR.ACCORD_15, CAR.ACCORDH, CAR.CIVIC_BOSCH, CAR.CIVIC_HATCH_MANUAL_10):
    ...
    if self.CP.radarOffCan:
      ...
      if self.CP.carFingerprint in (CAR.CIVIC_BOSCH, CAR.CIVIC_HATCH_MANUAL_10, CAR.ACCORDH):
        self.brake_switch = cp.vl["POWERTRAIN_DATA"]['BRAKE_SWITCH']
