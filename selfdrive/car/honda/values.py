...
class HondaCarInfo(CarInfo):
  package: Enum = Package.honda_sensing
...
CAR_INFO: Dict[str, Optional[Union[HondaCarInfo, List[HondaCarInfo]]]] = {
  ...
  CAR.ACURA_ILX: HondaCarInfo("Acura ILX 2016-19", Package.honda_acurawatch, min_steer_speed=25. * CV.MPH_TO_MS, harness=Harness.nidec),
  CAR.CRV: HondaCarInfo("Honda CR-V 2015-16", Package.honda_touring, harness=Harness.nidec),
  ...
  CAR.ACURA_RDX: HondaCarInfo("Acura RDX 2016-18", Package.honda_acurawatch, harness=Harness.nidec),
