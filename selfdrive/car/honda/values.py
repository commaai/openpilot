...
CAR_INFO: Dict[str, Optional[Union[HondaCarInfo, List[HondaCarInfo]]]] = {
  ...
  CAR.CIVIC_2022: HondaCarInfo("Honda Civic 2022", "All", harness=Harness.bosch_b),
...
HONDA_BOSCH_ALT_BRAKE_SIGNAL = {CAR.ACCORD, CAR.CRV_5G, CAR.ACURA_RDX_3G}  # no radarless car has this signal
