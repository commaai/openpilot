...
class CAR(StrEnum):
  ...
  HRV_3G_TWN = "HONDA HR-V 2023 TWN"
...
CAR_INFO: Dict[str, Optional[Union[HondaCarInfo, List[HondaCarInfo]]]] = {
  ...
  CAR.HRV_3G_TWN: None,  # Taiwan version of HRV
...
DBC = {
  ...
  CAR.HRV_3G_TWN: dbc_dict('honda_civic_ex_2022_can_generated', None),
...
HONDA_BOSCH = {CAR.ACCORD, CAR.ACCORDH, CAR.CIVIC_BOSCH, CAR.CIVIC_BOSCH_DIESEL, CAR.CRV_5G,
               CAR.CRV_HYBRID, CAR.INSIGHT, CAR.ACURA_RDX_3G, CAR.HONDA_E, CAR.CIVIC_2022, CAR.HRV_3G, CAR.HRV_3G_TWN}
HONDA_BOSCH_ALT_BRAKE_SIGNAL = {CAR.ACCORD, CAR.CRV_5G, CAR.ACURA_RDX_3G, CAR.HRV_3G}
HONDA_BOSCH_RADARLESS = {CAR.CIVIC_2022, CAR.HRV_3G, CAR.HRV_3G_TWN}
