...
FW_QUERY_CONFIG = FwQueryConfig(
  ...
  non_essential_ecus={
    ...
    Ecu.combinationMeter: [CAR.HONDA_ODYSSEY_CHN, CAR.HONDA_ACCORD, CAR.HONDA_CIVIC, CAR.HONDA_CIVIC_BOSCH, CAR.HONDA_CRV_5G],
    Ecu.gateway: [CAR.HONDA_FREED, CAR.HONDA_ODYSSEY_CHN, CAR.HONDA_ACCORD, CAR.HONDA_CIVIC, CAR.HONDA_CIVIC_BOSCH, CAR.HONDA_CRV_5G],
