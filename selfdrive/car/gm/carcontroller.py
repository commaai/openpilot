...
class CarController():
  ...
  def update(self, enabled, CS, frame, actuators, \
    ...
    if True:
      ...
      if (frame % 4) == 0:
        can_sends.append(gmcan.create_acc_dashboard_command(self.packer_pt, canbus.powertrain, enabled, hud_v_cruise * CV.MS_TO_KPH, hud_show_car, (enabled and CS.user_gas_pressed)))
