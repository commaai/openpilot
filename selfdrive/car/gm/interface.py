...
from openpilot.selfdrive.car.interfaces import CarInterfaceBase, TorqueFromLateralAccelCallbackType, FRICTION_THRESHOLD, ControllerState, ControllerStateHistory
...
class CarInterface(CarInterfaceBase):
  ...
  def torque_from_lateral_accel_siglin(self, controller_state: ControllerState, controller_state_history: ControllerStateHistory,
