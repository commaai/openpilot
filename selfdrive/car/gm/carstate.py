...
class CarState(CarStateBase):
  ...
  def get_can_parser(CP):
    ...
    if CP.carModel == CAR.VOLT:
      signals.append(("RegenPaddle", "EBCMRegenPaddle"))
      checks.append(("EBCMRegenPaddle", 50))

    return CANParser(DBC[CP.carModel]["pt"], signals, checks, CanBus.POWERTRAIN)
  ...
  def get_loopback_can_parser(CP):
    ...
    return CANParser(DBC[CP.carModel]["pt"], signals, checks, CanBus.LOOPBACK)
