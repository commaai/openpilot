...
class CarState(CarStateBase):
  ...
  def update(self, pt_cp, cam_cp, loopback_cp):
    ...
    # An Equinox has been seen with an unsupported status, so only check if either wheel is in reverse (2)
    # 0 - stationary, 1 - forward, 2 - reverse, 3 - unsupported, 4 - fault
