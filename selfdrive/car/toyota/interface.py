...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    ret.carName = "toyota"
    ret.safetyModes = [get_safety_mode(car.CarParams.SafetyModel.toyota)]
    ...
    if candidate == CAR.PRIUS:
      stop_and_go = True
      ret.safetyModes[0].safetyParam = 66  # see conversion factor for STEER_TORQUE_EPS in dbc file
      ret.wheelbase = 2.70
      ...
      ret.safetyModes[0].safetyParam = 73
      ret.wheelbase = 2.65
      ...
      stop_and_go = False
      ret.safetyModes[0].safetyParam = 88
      ret.wheelbase = 2.70
      ...
      stop_and_go = False
      ret.safetyModes[0].safetyParam = 77
      ...
      stop_and_go = True
      ret.safetyModes[0].safetyParam = 100
      ret.wheelbase = 2.60
      ret.steerRatio = 18.6
