...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    if candidate == CAR.PRIUS:
      ...
      set_lat_tune(ret.lateralTuning, 'INDI_PRIUS')
      ...
      set_lat_tune(ret.lateralTuning, 'LQR_RAV4')
      ...
      set_lat_tune(ret.lateralTuning, 'PID_A')
      ...
      set_lat_tune(ret.lateralTuning, 'PID_B')
      ...
      set_lat_tune(ret.lateralTuning, 'PID_C')
      ...
      ret.mass = 4387. * CV.LB_TO_KG + STD_CARGO_KG
      set_lat_tune(ret.lateralTuning, 'PID_D')
      ...
      set_lat_tune(ret.lateralTuning, 'PID_E')
      ...
      set_lat_tune(ret.lateralTuning, 'PID_F')
      ...
      set_lat_tune(ret.lateralTuning, 'PID_G')
      ...
      set_lat_tune(ret.lateralTuning, 'PID_H')
      ...
      for fw in car_fw:
        if fw.ecu == "eps" and (fw.fwVersion.startswith(b'\x02') or fw.fwVersion in [b'8965B42181\x00\x00\x00\x00\x00\x00']):
          set_lat_tune(ret.lateralTuning, 'PID_I')
          break
      ...
      set_lat_tune(ret.lateralTuning, 'PID_J')
      ...
      set_lat_tune(ret.lateralTuning, 'PID_L')
      ...
      set_lat_tune(ret.lateralTuning, 'PID_M')
      ...
      set_lat_tune(ret.lateralTuning, 'PID_N')
    ...
    if candidate in [CAR.LEXUS_CTH,]:
      ret.safetyConfigs[0].safetyParam = 100
    elif candidate in [CAR.LEXUS_IS,]:
      ret.safetyConfigs[0].safetyParam = 77
    elif candidate in [CAR.COROLLA,]:
      ret.safetyConfigs[0].safetyParam = 88
    elif candidate in [CAR.PRIUS,]:
