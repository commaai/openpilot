...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    if candidate == CAR.PRIUS:
      ...
      tire_stiffness_factor = 0.5533
      ret.mass = 1656. + STD_CARGO_KG  # mean between normal and hybrid
      set_lat_tune(ret.lateralTuning, LatTunes.LQR_RAV4)
      ...
      ret.mass = 1297. + STD_CARGO_KG  # mean between normal and hybrid
      ...
      tire_stiffness_factor = 0.5533
      ret.mass = 2033. + STD_CARGO_KG  # mean between min and max
      ...
      ret.steerRatio = 13.7
      tire_stiffness_factor = 0.7933
      ret.mass = 1542. + STD_CARGO_KG  # mean between normal and hybrid
      set_lat_tune(ret.lateralTuning, LatTunes.PID_C)
      ...
      ret.mass = 2132. + STD_CARGO_KG  # 4260 + 4-5 people
      ...
      ret.steerRatio = 16.0
      tire_stiffness_factor = 0.8
      ret.mass = 2090. + STD_CARGO_KG  # mean between normal and hybrid limited
      set_lat_tune(ret.lateralTuning, LatTunes.PID_G)
      ...
      ret.mass = 1590. + STD_CARGO_KG  # mean between normal and hybrid
      ...
      ret.steerRatio = 14.3
      tire_stiffness_factor = 0.7933
      ret.mass = 1626. + STD_CARGO_KG  # Average between ICE and Hybrid
      ...
      tire_stiffness_factor = 0.444  # not optimized yet
      ret.mass = 1668. + STD_CARGO_KG  # mean between min and max
      set_lat_tune(ret.lateralTuning, LatTunes.PID_D)
      ...
      ret.mass = 1410. + STD_CARGO_KG  # mean between min and max
