...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=[], disable_radar=False):  # pylint: disable=dangerous-default-value
    ...
    if candidate == CAR.PRIUS:
      ...
      set_lat_tune(ret, LatTunes.TORQUE, MAX_LAT_ACCEL=1.7, FRICTION=0.06)
      ...
      set_lat_tune(ret, LatTunes.TORQUE, MAX_LAT_ACCEL=1.8, FRICTION=0.06)
      ...
      set_lat_tune(ret, LatTunes.TORQUE, MAX_LAT_ACCEL=2.8, FRICTION=0.024)
      ...
      set_lat_tune(ret, LatTunes.PID_C)
      ...
      set_lat_tune(ret, LatTunes.PID_F)
      ...
      if candidate in (CAR.CAMRY_TSS2, CAR.CAMRYH_TSS2):
        set_lat_tune(ret, LatTunes.TORQUE, MAX_LAT_ACCEL=2.4, FRICTION=0.05)
      else:
        set_lat_tune(ret, LatTunes.PID_C)
      ...
      set_lat_tune(ret, LatTunes.PID_G)
      ...
      set_lat_tune(ret, LatTunes.PID_H)
      ...
      set_lat_tune(ret, LatTunes.PID_D)

      # 2019+ RAV4 TSS2 uses two different steering racks and specific tuning seems to be necessary.
      # See https://github.com/commaai/openpilot/pull/21429#issuecomment-873652891
      for fw in car_fw:
        if fw.ecu == "eps" and (fw.fwVersion.startswith(b'\x02') or fw.fwVersion in [b'8965B42181\x00\x00\x00\x00\x00\x00']):
          set_lat_tune(ret, LatTunes.PID_I)
          break
      ...
      set_lat_tune(ret, LatTunes.TORQUE, MAX_LAT_ACCEL=2.0, FRICTION=0.07)
      ...
      set_lat_tune(ret, LatTunes.PID_J)
      ...
      set_lat_tune(ret, LatTunes.PID_L)
      ...
      set_lat_tune(ret, LatTunes.PID_M)
      ...
      set_lat_tune(ret, LatTunes.PID_N)
