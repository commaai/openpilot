...
class CarController():
  ...
  def update(self, enabled, CS, frame, actuators, pcm_cancel_cmd, hud_alert,
    ...
    if CS.out.vEgo > CS.CP.minAccSpeed + self.pedal_hyst_gap:
      self.can_use_pedal = False
    elif CS.out.vEgo < CS.CP.minAccSpeed - self.pedal_hyst_gap:
      self.can_use_pedal = True

    if CS.CP.enableGasInterceptor and enabled and CS.out.vEgo < CS.CP.minAccSpeed and self.can_use_pedal:
