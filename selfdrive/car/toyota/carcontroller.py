...
from selfdrive.car import apply_steer_torque_error_limits, create_gas_interceptor_command, make_can_msg
...
class CarController:
  ...
  def update(self, CC, CS, now_nanos):
    ...
    apply_steer = apply_steer_torque_error_limits(new_steer, self.last_steer, CS.out.steeringTorqueEps, self.torque_rate_limits)
