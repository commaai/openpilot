...
# Enable blindspot debug mode once
    ...
    if (frame % 100 == 0 or send_ui) and ECU.CAM in self.fake_ecus:
      can_sends.append(create_ui_command(self.packer, steer, sound1, sound2, CS.lkas_barriers,  car.CarControl.HUDControl.leftLaneVisible, car.CarControl.HUDControl.rightLaneVisible))
