...
class CarController(object):
  ...
  def update(self, sendcan, enabled, CS, frame, actuators,
             pcm_cancel_cmd, hud_alert, audible_alert, forwarding_camera, left_line, right_line):
...
# Enable blindspot debug mode once
    ...
    if (frame % 100 == 0 or send_ui) and ECU.CAM in self.fake_ecus:
      can_sends.append(create_ui_command(self.packer, steer, sound1, sound2, CS.lkas_barriers, left_line + 1, right_line + 1))
