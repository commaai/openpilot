...
MAX_STEER_TORQUE = 1500  # 1500 units is about 2.3 m/s^2 on RAV4 2023
MAX_DRIVER_TORQUE_ALLOWANCE = 150  # slightly above steering pressed allows some resistence when changing lanes which
...
class CarController:
  ...
  def update(self, CC, CS, now_nanos):
    ...
    if self.frame % 2 == 0 and self.CP.carFingerprint in TSS2_CAR:
      ...
      full_torque_condition = (abs(CS.out.steeringTorqueEps) < MAX_STEER_TORQUE and
