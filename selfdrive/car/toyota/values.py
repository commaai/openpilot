...
CAR_INFO = {
  ...
  CAR.CAMRY: CarInfo("Toyota Camry 2018-20", "All", "https://www.youtube.com/watch?v=fkcjviZY9CM"),
  CAR.CAMRYH: CarInfo("Toyota Camry Hybrid 2018-20", "All", "https://www.youtube.com/watch?v=Q2DYY0AWKgk"),
  CAR.CAMRY_TSS2: CarInfo("Toyota Camry 2021-22", "All"),
  ...
  CAR.HIGHLANDER: CarInfo("Toyota Highlander 2017-19", "All", "https://www.youtube.com/watch?v=0wS0wXSLzoo"),
  CAR.HIGHLANDER_TSS2: CarInfo("Toyota Highlander 2020-22", "All"),
  CAR.HIGHLANDERH: CarInfo("Toyota Highlander Hybrid 2017-19", "All"),
  CAR.HIGHLANDERH_TSS2: CarInfo("Toyota Highlander Hybrid 2020-22", "All"),
  CAR.PRIUS: [
    CarInfo("Toyota Prius 2016-20", "TSS-P", "https://www.youtube.com/watch?v=8zopPJI8XQ0"),
    CarInfo("Toyota Prius Prime 2017-20", "All", "https://www.youtube.com/watch?v=8zopPJI8XQ0"),
  ],
  ...
  CAR.SIENNA: CarInfo("Toyota Sienna 2018-20", "All", "https://www.youtube.com/watch?v=q1UPOo4Sh68"),

  # Lexus
  CAR.LEXUS_CTH: CarInfo("Lexus CT Hybrid 2017-18", 'LSS'),
  CAR.LEXUS_ESH: CarInfo("Lexus ES Hybrid 2017-18", 'LSS'),
  ...
  CAR.LEXUS_NX: CarInfo("Lexus NX 2018-19", "All"),
  CAR.LEXUS_NXH: CarInfo("Lexus NX Hybrid 2018-19", "All"),
  CAR.LEXUS_NX_TSS2: CarInfo("Lexus NX 2020", "All"),
  CAR.LEXUS_RC: CarInfo("Lexus RC 2020", "All"),
  CAR.LEXUS_RX: CarInfo("Lexus RX 2016-18", "All"),
  CAR.LEXUS_RXH: CarInfo("Lexus RX Hybrid 2016-19", "All"),
