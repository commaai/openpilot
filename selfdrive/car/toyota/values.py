...
CAR_INFO: Dict[str, Union[ToyotaCarInfo, List[ToyotaCarInfo]]] = {
  ...
  CAR.CAMRY_TSS2: ToyotaCarInfo("Toyota Camry 2021-22", "TSS2", footnotes=[Footnote.CAMRY]),
  CAR.CAMRYH_TSS2: ToyotaCarInfo("Toyota Camry Hybrid 2021-22", "TSS2"),
  ...
  CAR.COROLLA_TSS2: [
    ToyotaCarInfo("Toyota Corolla 2019-22", video_link="https://www.youtube.com/watch?v=_66pXk0CBYA"),
