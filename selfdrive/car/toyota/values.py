...
from selfdrive.car.fw_versions_definitions import Fpv2Config, Request, SHORT_TESTER_PRESENT_REQUEST, SHORT_TESTER_PRESENT_RESPONSE, OBD_VERSION_REQUEST, OBD_VERSION_RESPONSE, \
