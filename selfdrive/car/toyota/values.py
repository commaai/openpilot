...
class CAR:
  ...
  CHRH_TSS2 = "TOYOTA C-HR HYBRID 2021" #TSS 2.5
...
CAR_INFO: Dict[str, Union[ToyotaCarInfo, List[ToyotaCarInfo]]] = {
  ...
  CAR.CHRH_TSS2: ToyotaCarInfo("Toyota C-HR Hybrid 2017-19"),
...
DBC = {
  ...
  CAR.CHRH_TSS2: dbc_dict('toyota_nodsu_pt_generated', 'toyota_adas'),
...
NO_DSU_CAR = TSS2_CAR | {CAR.CHR, CAR.CHRH, CAR.CHRH_TSS2, CAR.CAMRY, CAR.CAMRYH}
