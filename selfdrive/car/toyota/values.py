...
CAR_INFO = {
  ...
  CAR.CAMRYH: CarInfo("Toyota Camry Hybrid 2018-20", "All"),
  ...
  CAR.HIGHLANDER: CarInfo("Toyota Highlander 2017-19", "All"),
  ...
  CAR.PRIUS: [
    CarInfo("Toyota Prius 2016-20", 'TSS-P'),
  ...
  CAR.SIENNA: CarInfo("Toyota Sienna 2018-20", "All"),
