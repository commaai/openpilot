...
class CarControllerParams:
  ...
  # Observed internal torque rate limit on TSS 2.5 Camry and RAV4 is ~15 units/10ms frame when using LTA
...
ANGLE_CONTROL_CAR = {CAR.RAV4H_TSS2_2023, CAR.RAV4_TSS2_2023, CAR.CAMRYH_TSS2, CAR.COROLLA_TSS2}
