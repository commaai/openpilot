...
CAR_INFO = {
  ...
  CAR.AVALON: CarInfo("Toyota Avalon 2016-18", "TSS-P", footnotes=[1]),
  CAR.AVALON_2019: CarInfo("Toyota Avalon 2019-21", "TSS-P"),
  CAR.AVALONH_2019: CarInfo("Toyota Avalon Hybrid 2019-21", "TSS-P", footnotes=[1]),
  CAR.AVALON_TSS2: CarInfo("Toyota Avalon 2022", "All"),
  CAR.CAMRY: CarInfo("Toyota Camry 2018-20", "All", "https://www.youtube.com/watch?v=fkcjviZY9CM", footnotes=[2]),
  CAR.CAMRYH: CarInfo("Toyota Camry Hybrid 2018-20", "All", "https://www.youtube.com/watch?v=Q2DYY0AWKgk", footnotes=[2]),
  CAR.CAMRY_TSS2: CarInfo("Toyota Camry 2021-22", "All", footnotes=[2]),
  ...
  CAR.COROLLA: CarInfo("Toyota Corolla 2017-19", "All", footnotes=[1]),
  CAR.COROLLA_TSS2: [
  ...
  CAR.HIGHLANDER: CarInfo("Toyota Highlander 2017-19", "All", "https://www.youtube.com/watch?v=0wS0wXSLzoo", footnotes=[1]),
  CAR.HIGHLANDER_TSS2: CarInfo("Toyota Highlander 2020-22", "All"),
  CAR.HIGHLANDERH: CarInfo("Toyota Highlander Hybrid 2017-19", "All", footnotes=[1]),
  CAR.HIGHLANDERH_TSS2: CarInfo("Toyota Highlander Hybrid 2020-22", "All"),
  CAR.PRIUS: [
    CarInfo("Toyota Prius 2016-20", "TSS-P", "https://www.youtube.com/watch?v=8zopPJI8XQ0", footnotes=[1, 7]),
    CarInfo("Toyota Prius Prime 2017-20", "All", "https://www.youtube.com/watch?v=8zopPJI8XQ0", footnotes=[1, 7]),
  ],
  CAR.PRIUS_V: CarInfo("Toyota Prius v 2017", "TSS-P", min_enable_speed=MIN_ACC_SPEED, footnotes=[1, 7]),
  CAR.PRIUS_TSS2: [
  ...
  CAR.RAV4: CarInfo("Toyota RAV4 2016-18", "TSS-P", footnotes=[1]),
  CAR.RAV4H: CarInfo("Toyota RAV4 Hybrid 2016-18", "TSS-P", footnotes=[1]),
  ...
  CAR.SIENNA: CarInfo("Toyota Sienna 2018-20", "All", "https://www.youtube.com/watch?v=q1UPOo4Sh68", footnotes=[1]),

  # Lexus
  CAR.LEXUS_CTH: CarInfo("Lexus CT Hybrid 2017-18", "LSS", footnotes=[1]),
  CAR.LEXUS_ESH: CarInfo("Lexus ES Hybrid 2017-18", "LSS", footnotes=[1]),
  ...
  CAR.LEXUS_NX: CarInfo("Lexus NX 2018-19", "All", footnotes=[1]),
  CAR.LEXUS_NXH: CarInfo("Lexus NX Hybrid 2018-19", "All", footnotes=[1]),
  CAR.LEXUS_NX_TSS2: CarInfo("Lexus NX 2020", "All"),
  CAR.LEXUS_RC: CarInfo("Lexus RC 2020", "All"),
  CAR.LEXUS_RX: CarInfo("Lexus RX 2016-18", "All", footnotes=[1]),
  CAR.LEXUS_RXH: CarInfo("Lexus RX Hybrid 2016-19", "All", footnotes=[1]),
