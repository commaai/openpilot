...
class CAR:
  ...
  COROLLAH = "TOYOTA COROLLA HYBRID 2020"
...
DBC = {
  ...
  CAR.COROLLAH: dbc_dict('toyota_chr_hybrid_2018_pt_generated', 'toyota_prius_2017_adas'),
  
}

NO_DSU_CAR = [CAR.CHR, CAR.CHRH, CAR.CAMRY, CAR.CAMRYH]
TSSP2_CAR = [CAR.RAV4_2019, CAR.COROLLA_HATCH, CAR.COROLLAH]
NO_STOP_TIMER_CAR = [CAR.RAV4H, CAR.HIGHLANDERH, CAR.HIGHLANDER, CAR.RAV4_2019, CAR.COROLLA_HATCH, CAR.COROLLAH]  # no resume button press required
