...
DBC = {
  ...
  CAR.CHR: dbc_dict('toyota_nodsu_pt_generated', None),
  CAR.CHR_TSS2: dbc_dict('toyota_nodsu_pt_generated', None),
  CAR.CHRH: dbc_dict('toyota_nodsu_pt_generated', None),
  CAR.CHRH_TSS2: dbc_dict('toyota_nodsu_pt_generated', None),
  CAR.CAMRY: dbc_dict('toyota_nodsu_pt_generated', None),
  CAR.CAMRYH: dbc_dict('toyota_nodsu_pt_generated', None),
