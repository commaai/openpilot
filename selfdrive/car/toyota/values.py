...
class CAR(Platforms):
  ...
  TOYOTA_AVALON = PlatformConfig(
    ...
    dbc_dict=dbc_dict('toyota_tnga_k_pt_generated', 'toyota_adas'),
  )
  TOYOTA_AVALON_2019 = PlatformConfig(
    ...
    specs=TOYOTA_AVALON.specs,
    dbc_dict=dbc_dict('toyota_nodsu_pt_generated', 'toyota_adas'),
  )
  ...
  TOYOTA_PRIUS_V = PlatformConfig(
    car_docs=[ToyotaCarDocs("Toyota Prius v 2017", "Toyota Safety Sense P", min_enable_speed=MIN_ACC_SPEED)],
  ...
  TOYOTA_MIRAI = ToyotaTSS2PlatformConfig( # TSS 2.5
    car_docs=[ToyotaCarDocs("Toyota Mirai 2021")],
    specs=CarSpecs(mass=4300. * CV.LB_TO_KG, wheelbase=2.91, steerRatio=14.8, tireStiffnessFactor=0.8),
  )
  TOYOTA_SIENNA = PlatformConfig(
    car_docs=[ToyotaCarDocs("Toyota Sienna 2018-20", video_link="https://www.youtube.com/watch?v=q1UPOo4Sh68", min_enable_speed=MIN_ACC_SPEED)],
  ...
  LEXUS_CTH = PlatformConfig(
    car_docs=[ToyotaCarDocs("Lexus CT Hybrid 2017-18", "Lexus Safety System+")],
  ...
  LEXUS_IS = PlatformConfig(
    car_docs=[ToyotaCarDocs("Lexus IS 2017-19")],
  ...
  LEXUS_IS_TSS2 = ToyotaTSS2PlatformConfig(
    car_docs=[ToyotaCarDocs("Lexus IS 2022-23")],
  ...
  LEXUS_GS_F = PlatformConfig(
    car_docs=[ToyotaCarDocs("Lexus GS F 2016")],
