...
CAR_INFO = {
  # Toyota
  CAR.ALPHARD_TSS2: CarInfo("Toyota Alphard", {2019, 2020}, "All"),
  ...
  CAR.CAMRY: CarInfo("Toyota Camry", {2018, 2019, 2020}, "All"),
  CAR.CAMRYH: CarInfo("Toyota Camry Hybrid", {2018, 2019, 2020}, "All"),
  CAR.CAMRY_TSS2: CarInfo("Toyota Camry", {2021, 2022}, "All"),  # TSS 2.5
  CAR.CAMRYH_TSS2: CarInfo("Toyota Camry Hybrid", {2021, 2022}, "All"),
  CAR.CHR: CarInfo("Toyota C-HR", {2017, 2018, 2019, 2020, 2021}, "All"),
  CAR.CHRH: CarInfo("Toyota C-HR Hybrid", {2017, 2018, 2019}, "All"),
  CAR.COROLLA: CarInfo("Toyota Corolla", {2017, 2018, 2019}, "All"),
  CAR.COROLLA_TSS2: CarInfo("Toyota Corolla TSS2", {2020, 2021, 2022}, "All"),
  # LSS2 Lexus UX Hybrid is same as a TSS2 Corolla Hybrid
  CAR.COROLLAH_TSS2: CarInfo("Toyota Corolla Hybrid TSS2", {2020, 2021, 2022}, "All"),
  CAR.HIGHLANDER: CarInfo("Toyota Highlander", {2017, 2018, 2019}, "All"),
  CAR.HIGHLANDER_TSS2: CarInfo("Toyota Highlander", {2020, 2021, 2022}, "All"),
  ...
  CAR.PRIUS: [
    CarInfo("Toyota Prius", {2016, 2017, 2018, 2019, 2020}, 'TSS-P'),
    CarInfo("Toyota Prius Prime", {2017, 2018, 2019, 2020}, 'All'),
  ],
  ...
  CAR.RAV4_TSS2: CarInfo("Toyota RAV4", {2019, 2020, 2021}, "All"),
  CAR.RAV4H_TSS2: CarInfo("Toyota RAV4 Hybrid", {2019, 2020, 2021}, "All"),
  CAR.MIRAI: CarInfo("Toyota Mirai", {2021}, "All"),  # TSS 2.5
  CAR.SIENNA: CarInfo("Toyota Sienna", {2018, 2019, 2020}, "All"),

  # Lexus
  CAR.LEXUS_CTH: CarInfo("Lexus CT Hybrid", {2017, 2018}, 'LSS'),
  CAR.LEXUS_ESH: CarInfo("Lexus ES Hybrid", {2017, 2018}, 'LSS'),
  CAR.LEXUS_ES_TSS2: CarInfo("Lexus ES", {2019, 2020, 2021}, "All"),
  CAR.LEXUS_ESH_TSS2: CarInfo("Lexus ES Hybrid", {2019, 2020, 2021}, "All"),
  CAR.LEXUS_IS: CarInfo("Lexus IS", {2017, 2018, 2019}, "All"),
  CAR.LEXUS_NX: CarInfo("Lexus NX", {2018, 2019}, "All"),
  CAR.LEXUS_NXH: CarInfo("Lexus NX Hybrid", {2018, 2019}, "All"),
  CAR.LEXUS_NX_TSS2: CarInfo("Lexus NX", {2020}, "All"),
  CAR.LEXUS_RC: CarInfo("Lexus RC", {2020}, "All"),
  CAR.LEXUS_RX: CarInfo("Lexus RX", {2016, 2017, 2018}, "All"),
  CAR.LEXUS_RXH: CarInfo("Lexus RX Hybrid", {2016, 2017, 2018, 2019}, "All"),
  CAR.LEXUS_RX_TSS2: CarInfo("Lexus RX", {2020, 2021}, "All"),
  CAR.LEXUS_RXH_TSS2: CarInfo("Lexus RX Hybrid", {2020, 2021}, "All"),
}
