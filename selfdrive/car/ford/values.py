...
class CarControllerParams:
  ...
  ANGLE_RATE_LIMIT_UP = AngleRateLimit(speed_bp=[5, 15, 25], angle_v=[0.003, 0.00056, 0.0002])
  ANGLE_RATE_LIMIT_DOWN = AngleRateLimit(speed_bp=[5, 15, 25], angle_v=[0.005, 0.00089, 0.00032])
