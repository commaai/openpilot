...
def create_lat_ctl_msg(packer, mode: int, ramp_type: int, precision: int, path_offset: float, path_angle: float,
  ...
  values = {
    ...
    "LatCtl_D_Rq": mode,                                    # Mode: 0=None, 1=ContinuousPathFollowing,
                                                            # 2=InterventionLeft, 3=InterventionRight, 4-7=NotUsed [0|7]
