...
def can_fingerprint(can_func: Callable) -> Tuple[Optional[str], Dict[int, dict]]:
...
def fingerprint(logcan, sendcan, num_pandas):
  ...
  can_func = partial(get_one_can, logcan)
  car_fingerprint, finger = can_fingerprint(can_func)
