...
def fingerprint(logcan, sendcan, num_pandas):
  ...
  if not skip_fw_query:
    ...
    if cached_params is not None and len(cached_params.carFw) > 0 and cached_params.carVin is not VIN_UNKNOWN:
      ...
      print('OBDOBDOBDOBDOBDOBDOBDOBDOBDOBDOBD - setting obd_multiplexing to True for VIN')
  ...
  print('OBDOBDOBDOBDOBDOBDOBDOBDOBDOBDOBD - setting obd_multiplexing to False for ECU knockouts')
