...
if __name__ == "__main__":
  ...
  vin_bus, vin_rx_addr, vin = get_vin(logcan, sendcan, args.timeout, args.retry, debug=args.debug)
  print(f'RX: {hex(vin_rx_addr)}, BUS: {vin_bus}, VIN: {vin}')
