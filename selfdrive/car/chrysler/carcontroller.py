...
from selfdrive.car import apply_steer_torque_error_limits
...
class CarController:
  ...
  def update(self, CC, CS, now_nanos):
    ...
    if self.frame % self.params.STEER_STEP == 0:
      ...
      apply_steer = apply_steer_torque_error_limits(new_steer, self.apply_steer_last, CS.out.steeringTorqueEps, self.params)
