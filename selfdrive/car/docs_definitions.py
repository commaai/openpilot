...
class DashcamReason(Enum):
  MISSING_ROUTE = ("Missing test route", "Every openpilot platform requires a test route to ensure a minimum standard of quality, " +
                   "and we are missing one for these cars. Once test routes are available from users, these cars will be supported.")
