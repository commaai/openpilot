...
class CarHarness(EnumBase):
  ...
  ford_q3 = BaseCarHarness("Ford Q3 connector", parts=[Accessory.harness_box, Accessory.comma_power_v2, Cable.rj45_cable_7ft, Cable.right_angle_obd_c_cable_1_5ftA])
