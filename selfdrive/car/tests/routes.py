...
routes = [
  ...
  CarTestRoute("1bbe6bf2d62f58a8|2022-07-14--17-11-43", SUBARU.OUTBACK, segment=10), # outback
  CarTestRoute("c56e69bbc74b8fad|2022-08-18--09-43-51", SUBARU.OUTBACK, segment=3), # legacy
