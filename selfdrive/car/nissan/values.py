...
NISSAN_DIAGNOSTIC_REQUEST_KWP_2 = bytes([uds.SERVICE_TYPE.DIAGNOSTIC_SESSION_CONTROL, 0xfa])
NISSAN_DIAGNOSTIC_RESPONSE_KWP_2 = bytes([uds.SERVICE_TYPE.DIAGNOSTIC_SESSION_CONTROL + 0x40, 0xfa])
...
FW_QUERY_CONFIG = FwQueryConfig(
  requests=[
    ...
    Request(
      ...
      [NISSAN_DIAGNOSTIC_REQUEST_KWP_2, NISSAN_VERSION_RESPONSE_KWP],
    ),
    Request(
