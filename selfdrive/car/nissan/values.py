...
from selfdrive.car.docs_definitions import CarInfo, CarPart, CarParts, Part
...
NISSAN_PARTS: List[Part] = [CarPart.harness_box(), CarPart.rj45_cable_7ft(), CarPart.long_obdc_cable(), CarPart.usbc_coupler(), CarPart.mount(), CarPart.right_angle_obd_c_cable_1_5ft()]
