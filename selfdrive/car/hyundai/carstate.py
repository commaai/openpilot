...
from selfdrive.car.hyundai.values import HyundaiFlags, CAR, DBC, GEARS, CAMERA_SCC_CAR, CANFD_CAR, EV_CAR, HYBRID_CAR, Buttons, CarControllerParams
...
class CarState(CarStateBase):
  def __init__(self, CP):
    ...
    elif self.CP.carFingerprint in GEARS["use_cluster_gears"]:
      self.shifter_values = can_define.dv["CLU15"]["CF_Clu_Gear"]
    elif self.CP.carFingerprint in GEARS["use_tcu_gears"]:
  ...
  def update(self, cp, cp_cam):
    ...
    if self.CP.carFingerprint in GEARS["use_cluster_gears"]:
      gear = cp.vl["CLU15"]["CF_Clu_Gear"]
    elif self.CP.carFingerprint in GEARS["use_tcu_gears"]:
      gear = cp.vl["TCU12"]["CUR_GR"]
    elif self.CP.carFingerprint in GEARS["use_elect_gears"]:
  ...
  def get_can_parser(CP):
    ...
    if CP.carFingerprint in GEARS["use_cluster_gears"]:
      signals.append(("CF_Clu_Gear", "CLU15"))
    elif CP.carFingerprint in GEARS["use_tcu_gears"]:
      signals.append(("CUR_GR", "TCU12"))
      checks.append(("TCU12", 100))
    elif CP.carFingerprint in GEARS["use_elect_gears"]:
