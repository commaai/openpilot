...
from selfdrive.car.hyundai.values import HyundaiFlags, DBC, FEATURES, CAMERA_SCC_CAR, CANFD_CAR, EV_CAR, HYBRID_CAR, Buttons
...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam):
    ...
    ret.steeringPressed = abs(ret.steeringTorque) > 150  # TODO: in CCP?
  ...
  def update_canfd(self, cp, cp_cam):
    ...
    ret.steeringPressed = abs(ret.steeringTorque) > 250
