...
class SteerLimitParams:
  def __init__(self, CP):
    if CP.carFingerprint in [CAR.SONATA, CAR.PALISADE, CAR.SANTA_FE, CAR.VELOSTER, CAR.GENESIS_G70, CAR.KONA]:
      self.STEER_MAX = 384
    else:
      self.STEER_MAX = 255
...
FW_VERSIONS = {
  ...
  CAR.KONA: {
    ...
    (Ecu.engine, 0x7e0, None): [
      ...
      b'\x01TOS-0NU06F100H02', 
    ],
    (Ecu.eps, 0x7d4, None): [
      b'\xf1\x00OS  MDPS C 1.00 1.05 56310J9030\x00 4OSDC105', 
      b'\xf1\x00OS  MDPS C 1.00 1.05 56310/J9030 4OSDC105', 
    ],
    ...
    (Ecu.transmission, 0x7e1, None): [
      ...
      b'\xf1\x816U2VE051\x00\x00\xf1\x006U2V0_C2\x00\x006U2VE051\x00\x00DOS0T16NS3\xd1\xa2U\xd7'
    ],
  },
  CAR.KONA_EV: {
