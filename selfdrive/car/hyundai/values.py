...
ELECTRIC_CAR = set([CAR.IONIQ_EV_2020, CAR.IONIQ_EV_LTD, CAR.KONA_EV, CAR.KIA_NIRO_EV])
HYBRID_CAR = set([CAR.IONIQ, CAR.KIA_OPTIMA_H])  # hybrid or plugin
...
DBC = {
  ...
  CAR.IONIQ: dbc_dict('hyundai_hybrid_generated', None),
  CAR.KIA_FORTE: dbc_dict('hyundai_kia_generic', None),
  CAR.KIA_NIRO_EV: dbc_dict('hyundai_electric_generated', None),
  CAR.KIA_OPTIMA: dbc_dict('hyundai_kia_generic', None),
  CAR.KIA_OPTIMA_H: dbc_dict('hyundai_hybrid_generated', None),
