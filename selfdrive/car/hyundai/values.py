...
FW_VERSIONS = {
  ...
  CAR.PALISADE: {
    ...
    (Ecu.transmission, 0x7e1, None): [
      ...
      b'\xf1\x87LBNUCA4789724HH0\x98\x87\x88x\x98\x88h\x86w\x88\x87xx\x88\x87\x88w\x88\x97xu?\xfb\xff\x97w\x8f\xff\x05\x04\xf1\x81U922\x00\x00\x00\x00\x00\x00\xf1\x00bcsh8p54  U922\x00\x00\x00\x00\x00\x00TON2G38NB5j\x94.\xde',
    ],
  },
  CAR.VELOSTER: {
    (Ecu.fwdRadar, 0x7d0, None): [
