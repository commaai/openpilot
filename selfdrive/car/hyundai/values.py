...
CAR_INFO: Dict[str, Optional[Union[HyundaiCarInfo, List[HyundaiCarInfo]]]] = {
  ...
  CAR.ELANTRA_HEV_2021: HyundaiCarInfo("Hyundai Elantra Hybrid 2021-22", "Smart Cruise Control", video_link="https://youtu.be/_EdYQtV52-c", harness=Harness.hyundai_k),
  ...
  CAR.IONIQ_PHEV: HyundaiCarInfo("Hyundai Ioniq Plug-in Hybrid 2020-21", "Smart Cruise Control", harness=Harness.hyundai_h),
  CAR.KONA: HyundaiCarInfo("Hyundai Kona 2020", "Smart Cruise Control", harness=Harness.hyundai_b),
  ...
  CAR.TUCSON: [
    HyundaiCarInfo("Hyundai Tucson 2021", "Smart Cruise Control", min_enable_speed=19 * CV.MPH_TO_MS, harness=Harness.hyundai_l),
    HyundaiCarInfo("Hyundai Tucson Diesel 2019", "Smart Cruise Control", harness=Harness.hyundai_l),
  ],
  CAR.PALISADE: [
  ...
  CAR.VELOSTER: HyundaiCarInfo("Hyundai Veloster 2019-20", "Smart Cruise Control", min_enable_speed=5. * CV.MPH_TO_MS, harness=Harness.hyundai_e),
  ...
  CAR.KIA_SELTOS: HyundaiCarInfo("Kia Seltos 2021", "Smart Cruise Control", harness=Harness.hyundai_a),
  CAR.KIA_SORENTO: [
