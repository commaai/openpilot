...
CANFD_EV_CAR = {
  CAR.IONIQ_5, CAR.IONIQ_6,
  CAR.KIA_EV6, CAR.KIA_NIRO_EV_2ND_GEN,
  CAR.GENESIS_GV60_EV_1ST_GEN, CAR.GENESIS_GV70_1ST_GEN, CAR.GENESIS_GV80,
}

CANFD_HEV_CAR = {
  CAR.TUCSON_HYBRID_4TH_GEN,
  CAR.KIA_SPORTAGE_HYBRID_5TH_GEN, CAR.KIA_SORENTO_PHEV_4TH_GEN, CAR.KIA_NIRO_HEV_2ND_GEN,
}

CANFD_ICE_CAR = {
  CAR.TUCSON_4TH_GEN, CAR.SANTA_CRUZ_1ST_GEN,
  CAR.KIA_SPORTAGE_5TH_GEN, CAR.KIA_SORENTO_4TH_GEN, CAR.KIA_CARNIVAL_4TH_GEN,
}

CANFD_CAR = CANFD_EV_CAR | CANFD_HEV_CAR | CANFD_ICE_CAR
...
HEV_CAR = {CAR.IONIQ_PHEV, CAR.ELANTRA_HEV_2021, CAR.KIA_NIRO_PHEV, CAR.KIA_NIRO_HEV_2021, CAR.SONATA_HYBRID, CAR.KONA_HEV, CAR.IONIQ,
