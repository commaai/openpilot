...
FW_VERSIONS = {
  ...
  CAR.SONATA: {
    ...
    (Ecu.transmission, 0x7e1, None): [
      ...
      b'\xf1\x87SAMFBA9708354GJ2wwwwVf\x86h\x88wx\x87xww\x87\x88\x88\x88\x88w/\xfa\xff\x97w\x8f\xff\x86\xa0',
      b'\xf1\x81U913\x00\x00\x00\x00\x00\x00\xf1\x00bcsh8p54  U913\x00\x00\x00\x00\x00\x00SDN8T16NB2\n\xdd^\xbc',
    ],
  },
  CAR.SONATA_LF: {
    (Ecu.fwdRadar, 0x7d0, None): [
