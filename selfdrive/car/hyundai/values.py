...
IGNORED_FINGERPRINTS = [CAR.VELOSTER, CAR.KONA, CAR.KIA_FORTE, CAR.KIA_SPORTAGE, CAR.KIA_NIRO_HEV]
...
FEATURES = {
  ...
  "use_elect_gears": set([CAR.KIA_OPTIMA_H, CAR.SONATA_H, CAR.IONIQ_EV_LTD, CAR.IONIQ, CAR.KONA_EV, CAR.KIA_NIRO_EV, CAR.KIA_CADENZA_HEV,
                      CAR.GRANDEUR_HEV, CAR.KIA_NIRO_HEV, CAR.KONA_HEV]),

  # these cars use the FCA11 message for the AEB and FCW signals, all others use SCC12
  "use_fca": set([CAR.SONATA, CAR.SONATA_H, CAR.ELANTRA, CAR.ELANTRA_GT_I30, CAR.KIA_STINGER, CAR.IONIQ, CAR.KONA, CAR.KONA_EV,
...
EV_HYBRID = set([CAR.KIA_OPTIMA_H, CAR.SONATA_H, CAR.IONIQ_EV_LTD, CAR.IONIQ, CAR.KONA_EV, CAR.KIA_NIRO_EV, CAR.KIA_CADENZA_HEV,
             CAR.GRANDEUR_HEV, CAR.KIA_NIRO_HEV, CAR.KONA_HEV]),
