...
class CAR:
  ...
  KIA_OPTIMA_G4_5 = "KIA OPTIMA 4TH GEN FACELIFT"
...
CAR_INFO: Dict[str, Optional[Union[HyundaiCarInfo, List[HyundaiCarInfo]]]] = {
  ...
  CAR.KIA_OPTIMA_G4_5: HyundaiCarInfo("Kia Optima 2019-20", harness=Harness.hyundai_g),
  CAR.KIA_OPTIMA_H: [
...
FEATURES = {
  ...
  "use_tcu_gears": {CAR.KIA_OPTIMA_G4, CAR.KIA_OPTIMA_G4_5, CAR.SONATA_LF, CAR.VELOSTER, CAR.TUCSON},
...
LEGACY_SAFETY_MODE_CAR = {CAR.HYUNDAI_GENESIS, CAR.IONIQ_EV_2020, CAR.IONIQ_EV_LTD, CAR.IONIQ_PHEV, CAR.IONIQ, CAR.KONA_EV, CAR.KIA_SORENTO, CAR.SONATA_LF, CAR.KIA_OPTIMA_G4, CAR.KIA_OPTIMA_G4_5, CAR.VELOSTER, CAR.KIA_STINGER, CAR.GENESIS_G70, CAR.GENESIS_G80, CAR.KIA_CEED, CAR.ELANTRA, CAR.IONIQ_HEV_2022}
...
DBC = {
  ...
  CAR.KIA_OPTIMA_G4_5: dbc_dict('hyundai_kia_generic', None),
