...
FW_VERSIONS = {
  ...
  # Disabled: Kia Niro HEV is a dead-on match for Kia Optima HEV. Can't combine
  # because they have a different wheelbase and different gear messages. May
  # need to add more addresses to the HKG FPv2 query.
  # CAR.KIA_NIRO_HEV: {
  #   (Ecu.engine, 0x7e0, None): [
...
FEATURES = {
  ...
  "use_cluster_gears": set([CAR.ELANTRA, CAR.ELANTRA_GT_I30, CAR.KONA, CAR.KIA_NIRO_HEV]),
  ...
  "use_fca": set([CAR.SONATA, CAR.ELANTRA, CAR.ELANTRA_2021, CAR.ELANTRA_HEV_2021, CAR.ELANTRA_GT_I30, CAR.KIA_STINGER, CAR.IONIQ, CAR.IONIQ_EV_2020, CAR.IONIQ_PHEV, CAR.KONA_EV, CAR.KIA_FORTE, CAR.KIA_NIRO_EV, CAR.KIA_NIRO_HEV, CAR.PALISADE, CAR.GENESIS_G70, CAR.KONA, CAR.SANTA_FE, CAR.KIA_SELTOS]),
}
