...
class CAR:
  ...
  KIA_MORNING = "KIA ALL NEW MORNING 2019"
...
CAR_INFO: Dict[str, Union[HyundaiCarInfo, List[HyundaiCarInfo]]] = {
  ...
  CAR.KIA_MORNING: HyundaiCarInfo("Kia All New Morning 2019")
...
FINGERPRINTS = {
  ...
  """
  Put KIA_MORNING Fingerprint below(not yet found).
  CAR.KIA_MORNING: [{
...
FEATURES = {
  ...
  "use_elect_gears": {CAR.KIA_NIRO_EV, CAR.KIA_NIRO_HEV, CAR.KIA_NIRO_HEV_2021, CAR.KIA_OPTIMA_H, CAR.IONIQ_EV_LTD, CAR.KONA_EV, CAR.IONIQ, CAR.IONIQ_EV_2020, CAR.IONIQ_PHEV, CAR.ELANTRA_HEV_2021,CAR.SONATA_HYBRID, CAR.KONA_HEV, CAR.IONIQ_HEV_2022, CAR.SANTA_FE_HEV_2022, CAR.SANTA_FE_PHEV_2022, CAR.KIA_MORNING},
...
DBC = {
  ...
  CAR.KIA_MORNING: dbc_dict('hyundai_kia_generic', None),
}
