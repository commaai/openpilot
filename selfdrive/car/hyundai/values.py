...
FEATURES = {
  ...
  "use_cluster_gears": set([CAR.ELANTRA, CAR.ELANTRA_GT_I30, CAR.KONA, CAR.GRANDEUR_IG, CAR.GRANDEUR_IG_FL]),
  ...
  "use_fca": set([CAR.SONATA, CAR.ELANTRA, CAR.ELANTRA_GT_I30, CAR.KIA_STINGER, CAR.IONIQ, CAR.IONIQ_EV_2020, CAR.KONA_EV, CAR.KIA_FORTE, CAR.KIA_NIRO_EV, CAR.PALISADE, CAR.GENESIS_G70, CAR.KONA
                  CAR.GRANDEUR_IG_FL, CAR.GRANDEUR_IG_FL_HEV]),
...
EV_HYBRID = set([CAR.IONIQ_EV_2020, CAR.IONIQ_EV_LTD, CAR.IONIQ, CAR.KONA_EV, CAR.KIA_NIRO_EV, CAR.GRANDEUR_IG_HEV, CAR.GRANDEUR_IG_FL_HEV])
