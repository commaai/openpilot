...
CAR_INFO: Dict[str, Union[HyundaiCarInfo, List[HyundaiCarInfo]]] = {
  ...
  CAR.IONIQ: HyundaiCarInfo("Hyundai Ioniq Hybrid 2017-19", harness=Harness.hyundai_c),  # TODO: unsure if all are c
  ...
  CAR.IONIQ_PHEV_2019: HyundaiCarInfo("Hyundai Ioniq Plug-in Hybrid 2019", "SCC + LKAS", harness=Harness.hyundai_c),
  ...
  CAR.SANTA_FE_2022: [
    HyundaiCarInfo("Hyundai Santa Fe 2021", "All", harness=Harness.hyundai_d),  # TODO: what should we do here for the readme?
    HyundaiCarInfo("Hyundai Santa Fe 2022", "All", harness=Harness.hyundai_l),  # maybe auto group when generating if identcial? need string year parsing then...
  ],
  ...
  CAR.TUCSON_DIESEL_2019: HyundaiCarInfo("Hyundai Tucson Diesel 2019", "SCC + LKAS", harness=Harness.hyundai_l),
  CAR.PALISADE: [
  ...
  CAR.KIA_NIRO_EV: [
    HyundaiCarInfo("Kia Niro Electric 2019-20", "All", video_link="https://www.youtube.com/watch?v=lT7zcG6ZpGo", harness=Harness.hyundai_h),  # TODO: this looks fishy
  ...
  CAR.KIA_NIRO_HEV_2021: [
    HyundaiCarInfo("Kia Niro Hybrid 2021", harness=Harness.hyundai_f),  # TODO: this is also suspect, this PR says it's the D harness? https://github.com/commaai/openpilot/pull/21779
