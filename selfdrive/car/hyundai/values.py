...
class CAR:
  ...
  AZERA_7TH_GEN = "HYUNDAI AZERA 7TH GEN"
...
CAR_INFO: Dict[str, Optional[Union[HyundaiCarInfo, List[HyundaiCarInfo]]]] = {
  ...
  CAR.AZERA_7TH_GEN: HyundaiCarInfo("Hyundai Azera (Middle East only) 2022", "All", car_parts=CarParts.common([CarHarness.hyundai_k])),
...
DBC = {
  ...
  CAR.AZERA_7TH_GEN: dbc_dict('hyundai_kia_generic', None),
}
