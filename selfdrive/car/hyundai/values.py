...
class CAR:
  ...
  KIA_NIRO_EV_2ND_GEN = "KIA NIRO EV 2023"
...
CAR_INFO: Dict[str, Optional[Union[HyundaiCarInfo, List[HyundaiCarInfo]]]] = {
  ...
  CAR.KIA_NIRO_EV_2ND_GEN: HyundaiCarInfo("Kia Niro EV 2023", harness=Harness.hyundai_a),
  CAR.KIA_NIRO_PHEV: [
...
FW_VERSIONS = {
  ...
  CAR.KIA_NIRO_EV_2ND_GEN: {
    ...
    (Ecu.eps, 0x7D4, None): [
      b'\xf1\x00SG2 MDPS C A.00 1.03 56310AO000\x00 4SGVC103',
      b'\xf1\x8756310AO000\x00\xf1\x00SG2 MDPS C A.00 1.03 56310AO000\x00 4SGVC103',
    ],
    (Ecu.fwdCamera, 0x7C4, None): [
...
CANFD_RADAR_SCC_CAR = {CAR.GENESIS_GV70_1ST_GEN, CAR.KIA_SORENTO_PHEV_4TH_GEN, CAR.KIA_SORENTO_4TH_GEN, CAR.KIA_NIRO_EV_2ND_GEN}
