...
CHECKSUM = {
  "crc8": [CAR.SONATA_H, CAR.SANTA_FE, CAR.SONATA, CAR.PALISADE],
...
FEATURES = {
  ...
  "use_elect_gears": [CAR.SONATA_H, CAR.KIA_OPTIMA_H, CAR.IONIQ_EV_LTD, CAR.KONA_EV], # Use TCU Message for Gear Selection
}
