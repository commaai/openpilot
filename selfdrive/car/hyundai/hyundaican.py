...
def create_acc_commands(packer, enabled, active, accel, jerk_upper, idx, lead_visible, set_speed, stopping, gas_pressed):
  commands = []

  scc11_values = {
    "MainMode_ACC": 1,
    "TauGapSet": 4,  # TODO: experiment with this
  ...
  scc14_values = {
    ...
    "JerkLowerLimit": 12.7 if active else 0,  # max value to keep decel control tight
