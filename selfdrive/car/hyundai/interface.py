...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    ret.carName = "hyundai"
    ret.safetyModes = [get_safety_mode(car.CarParams.SafetyModel.hyundai, 0)]
    ...
    if candidate in [CAR.HYUNDAI_GENESIS, CAR.IONIQ_EV_2020, CAR.IONIQ_EV_LTD, CAR.IONIQ_PHEV, CAR.IONIQ, CAR.KONA_EV, CAR.KIA_SORENTO,
      ...
      ret.safetyModes = [get_safety_mode(car.CarParams.SafetyModel.hyundaiLegacy)]

    # set appropriate safety param for gas signal
    if candidate in HYBRID_CAR:
      ret.safetyModes[0].safetyParam = 2
    elif candidate in EV_CAR:
      ret.safetyModes[0].safetyParam = 1
    ...
    if ret.openpilotLongitudinalControl:
      ret.safetyModes[0].safetyParam |= Panda.FLAG_HYUNDAI_LONG
