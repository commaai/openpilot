...
class CarInterface(CarInterfaceBase):
  ...
  def update(self, c, can_strings):
    ...
    if self.CP.carFingerprint == CAR.OPTIMA:
      ret.leftBlinker = bool(self.CS.left_blinker_flash or self.CC.turning_signal_timer)
      ret.rightBlinker = bool(self.CS.right_blinker_flash or self.CC.turning_signal_timer)
