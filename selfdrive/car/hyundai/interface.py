...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=[], disable_radar=False):  # pylint: disable=dangerous-default-value
    ...
    if candidate in (CAR.SANTA_FE, CAR.SANTA_FE_2022, CAR.SANTA_FE_HEV_2022, CAR.SANTA_FE_PHEV_2022):
      ...
      torque_params = {'LAT_ACCEL_FACTOR': 2.0, 'FRICTION': 0.05}
      ...
      # TODO override until there is enough data
      if candidate == CAR.KONA:
        torque_params = CarInterfaceBase.get_torque_params(CAR.KONA_EV)
      ...
      if candidate not in (CAR.IONIQ_EV_2020, CAR.IONIQ_PHEV, CAR.IONIQ_HEV_2022):
        ret.minSteerSpeed = 32 * CV.MPH_TO_MS
      # TODO override until there is enough data
      if candidate == CAR.IONIQ_HEV_2022:
        torque_params = CarInterfaceBase.get_torque_params(CAR.IONIQ_EV_2020)
      ...
      # TODO override until there is enough data
      torque_params = {'LAT_ACCEL_FACTOR': 3.0, 'FRICTION': 0.05}
    ...
    # Kia
      ...
      # TODO override until there is enough data
      if candidate == CAR.KIA_NIRO_HEV:
        torque_params = CarInterfaceBase.get_torque_params(CAR.KIA_NIRO_EV)
      ...
      ret.steerRatio = 13.75
      tire_stiffness_factor = 0.5
      ret.maxLateralAccel = 4.0
      # TODO override until there is enough data
      torque_params = {'LAT_ACCEL_FACTOR': 4.0, 'FRICTION': 0.05}
      ...
      # TODO override until there is enough data
      torque_params = {'LAT_ACCEL_FACTOR': 1.5, 'FRICTION': 0.05}
