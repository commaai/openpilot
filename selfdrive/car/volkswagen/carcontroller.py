...
class CarController:
  ...
  def update(self, CC, CS, ext_bus, now_nanos):
    ...
    if self.frame % self.CCP.LDW_STEP == 0:
      ...
      can_sends.append(self.CCS.create_lka_hud_control(self.packer_pt, CANBUS.pt, self.CP, CS.ldw_stock_values, CC.enabled,
    ...
    if gra_send_ready and (CC.cruiseControl.cancel or CC.cruiseControl.resume):
      ...
      can_sends.append(self.CCS.create_acc_buttons_control(self.packer_pt, ext_bus, self.CP, CS.gra_stock_values, counter,
