...
CAR_INFO: Dict[str, Union[VWCarInfo, List[VWCarInfo]]] = {
  ...
  CAR.AUDI_A3_MK3: [
    VWCarInfo("Audi A3 2014-19", "Adaptive Cruise Control & Lane Assist"),
    VWCarInfo("Audi A3 Sportback e-tron 2017-18", "Adaptive Cruise Control & Lane Assist"),
    VWCarInfo("Audi RS3 2018", "Adaptive Cruise Control & Lane Assist"),
    VWCarInfo("Audi S3 2015-17", "Adaptive Cruise Control & Lane Assist"),
  ],
  CAR.AUDI_Q2_MK1: VWCarInfo("Audi Q2 2018", "Adaptive Cruise Control & Lane Assist"),
  CAR.AUDI_Q3_MK2: VWCarInfo("Audi Q3 2020-21", "Adaptive Cruise Control & Lane Assist"),
