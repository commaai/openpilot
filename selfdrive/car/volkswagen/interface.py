...
from openpilot.selfdrive.car.volkswagen.values import CAR, PQ_CARS, MLB_CARS, CANBUS, NetworkLocation, TransmissionType, GearShifter, VolkswagenFlags
...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret, candidate, fingerprint, car_fw, experimental_long, docs):
    ...
    ret.experimentalLongitudinalAvailable = candidate not in MLB_CARS and (ret.networkLocation == NetworkLocation.gateway or docs)
