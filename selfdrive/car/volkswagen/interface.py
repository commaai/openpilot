...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=None, experimental_long=False):
    ...
    generating_docs = len(fingerprint[0]) == 0  # Used to select autogenerated doc defaults for FP-sensed carParams
    ...
    if candidate in PQ_CARS:
      ...
      if 0x440 in fingerprint[0] or generating_docs:  # Getriebe_1
      ...
      if 0xAD in fingerprint[0] or generating_docs:  # Getriebe_11
        ret.transmissionType = TransmissionType.automatic
    ...
    ret.experimentalLongitudinalAvailable = ret.networkLocation == NetworkLocation.gateway or generating_docs
