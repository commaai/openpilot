...
const char* cl_get_error_string(int err) {
    switch (err) {
        ...
        // CL_ERR_TO_STR(CL_INVALID_D3D10_DEVICE_KHR);
        // CL_ERR_TO_STR(CL_INVALID_D3D10_RESOURCE_KHR);
        // CL_ERR_TO_STR(CL_D3D10_RESOURCE_ALREADY_ACQUIRED_KHR);
        // CL_ERR_TO_STR(CL_D3D10_RESOURCE_NOT_ACQUIRED_KHR);
        // CL_ERR_TO_STR(CL_INVALID_D3D11_DEVICE_KHR);
        // CL_ERR_TO_STR(CL_INVALID_D3D11_RESOURCE_KHR);
        // CL_ERR_TO_STR(CL_D3D11_RESOURCE_ALREADY_ACQUIRED_KHR);
        // CL_ERR_TO_STR(CL_D3D11_RESOURCE_NOT_ACQUIRED_KHR);
        // CL_ERR_TO_STR(CL_INVALID_DX9_MEDIA_ADAPTER_KHR);
        // CL_ERR_TO_STR(CL_INVALID_DX9_MEDIA_SURFACE_KHR);
        // CL_ERR_TO_STR(CL_DX9_MEDIA_SURFACE_ALREADY_ACQUIRED_KHR);
        // CL_ERR_TO_STR(CL_DX9_MEDIA_SURFACE_NOT_ACQUIRED_KHR);
        // CL_ERR_TO_STR(CL_INVALID_EGL_OBJECT_KHR);
        // CL_ERR_TO_STR(CL_EGL_RESOURCE_NOT_ACQUIRED_KHR);
        // CL_ERR_TO_STR(CL_PLATFORM_NOT_FOUND_KHR);
        // CL_ERR_TO_STR(CL_DEVICE_PARTITION_FAILED_EXT);
        // CL_ERR_TO_STR(CL_INVALID_PARTITION_COUNT_EXT);
        // CL_ERR_TO_STR(CL_INVALID_PARTITION_NAME_EXT);
        // CL_ERR_TO_STR(CL_INVALID_ACCELERATOR_INTEL);
        // CL_ERR_TO_STR(CL_INVALID_ACCELERATOR_TYPE_INTEL);
        // CL_ERR_TO_STR(CL_INVALID_ACCELERATOR_DESCRIPTOR_INTEL);
        // CL_ERR_TO_STR(CL_ACCELERATOR_TYPE_NOT_SUPPORTED_INTEL);
        // CL_ERR_TO_STR(CL_INVALID_GL_SHAREGROUP_REFERENCE_KHR);
        // CL_ERR_TO_STR(CL_INVALID_VA_API_MEDIA_ADAPTER_INTEL);
        // CL_ERR_TO_STR(CL_INVALID_VA_API_MEDIA_SURFACE_INTEL);
        // CL_ERR_TO_STR(CL_VA_API_MEDIA_SURFACE_ALREADY_ACQUIRED_INTEL);
        // CL_ERR_TO_STR(CL_VA_API_MEDIA_SURFACE_NOT_ACQUIRED_INTEL);
