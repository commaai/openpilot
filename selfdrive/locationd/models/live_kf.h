...
#define STATE_ECEF_POS_LEN (STATE_ECEF_POS_END - STATE_ECEF_POS_START)
#define STATE_ECEF_ORIENTATION_START 3  // quat for pose of phone in ecef
#define STATE_ECEF_ORIENTATION_END 7
#define STATE_ECEF_ORIENTATION_LEN (STATE_ECEF_ORIENTATION_END - STATE_ECEF_ORIENTATION_START)
#define STATE_ECEF_VELOCITY_START 7  // ecef velocity in m/s
#define STATE_ECEF_VELOCITY_END 10
#define STATE_ECEF_VELOCITY_LEN (STATE_ECEF_VELOCITY_END - STATE_ECEF_VELOCITY_START)
...
#define STATE_ANGULAR_VELOCITY_LEN (STATE_ANGULAR_VELOCITY_END - STATE_ANGULAR_VELOCITY_START)
#define STATE_GYRO_BIAS_START 13  // roll, pitch and yaw biases
#define STATE_GYRO_BIAS_END 16
#define STATE_GYRO_BIAS_LEN (STATE_GYRO_BIAS_END - STATE_GYRO_BIAS_START)
#define STATE_ODO_SCALE_START 16  // odometer scale
#define STATE_ODO_SCALE_END 17
#define STATE_ODO_SCALE_LEN (STATE_ODO_SCALE_END - STATE_ODO_SCALE_START)
#define STATE_ACCELERATION_START 17  // Acceleration in device frame in m/s**2
#define STATE_ACCELERATION_END 20
#define STATE_ACCELERATION_LEN (STATE_ACCELERATION_END - STATE_ACCELERATION_START)
#define STATE_IMU_OFFSET_START 20  // imu offset angles in radians
#define STATE_IMU_OFFSET_END 23
#define STATE_IMU_OFFSET_LEN (STATE_IMU_OFFSET_END - STATE_IMU_OFFSET_START)

// Error-state has different slices because it is an ESKF
#define STATE_ECEF_POS_ERR_START 0
#define STATE_ECEF_POS_ERR_END 3
#define STATE_ECEF_POS_ERR_LEN (STATE_ECEF_POS_ERR_END - STATE_ECEF_POS_ERR_START)
#define STATE_ECEF_ORIENTATION_ERR_START 3  // euler angles for orientation error
#define STATE_ECEF_ORIENTATION_ERR_END 6
#define STATE_ECEF_ORIENTATION_ERR_LEN (STATE_ECEF_ORIENTATION_ERR_END - STATE_ECEF_ORIENTATION_ERR_START)
#define STATE_ECEF_VELOCITY_ERR_START 6
#define STATE_ECEF_VELOCITY_ERR_END 9
#define STATE_ECEF_VELOCITY_ERR_LEN (STATE_ECEF_VELOCITY_ERR_END - STATE_ECEF_VELOCITY_ERR_START)
#define STATE_ANGULAR_VELOCITY_ERR_START 9
#define STATE_ANGULAR_VELOCITY_ERR_END 12
#define STATE_ANGULAR_VELOCITY_ERR_LEN (STATE_ANGULAR_VELOCITY_ERR_END - STATE_ANGULAR_VELOCITY_ERR_START)
#define STATE_GYRO_BIAS_ERR_START 12
#define STATE_GYRO_BIAS_ERR_END 15
#define STATE_GYRO_BIAS_ERR_LEN (STATE_GYRO_BIAS_ERR_END - STATE_GYRO_BIAS_ERR_START)
#define STATE_ODO_SCALE_ERR_START 15
#define STATE_ODO_SCALE_ERR_END 16
#define STATE_ODO_SCALE_ERR_LEN (STATE_ODO_SCALE_ERR_END - STATE_ODO_SCALE_ERR_START)
#define STATE_ACCELERATION_ERR_START 16
#define STATE_ACCELERATION_ERR_END 19
#define STATE_ACCELERATION_ERR_LEN (STATE_ACCELERATION_ERR_END - STATE_ACCELERATION_ERR_START)
#define STATE_IMU_OFFSET_ERR_START 19
#define STATE_IMU_OFFSET_ERR_END 22
#define STATE_IMU_OFFSET_ERR_LEN (STATE_IMU_OFFSET_ERR_END - STATE_IMU_OFFSET_ERR_START)
