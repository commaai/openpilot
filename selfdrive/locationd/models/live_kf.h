...
public:
  ...
  std::optional<Estimate> predict_and_observe(double t, int kind, std::vector<Eigen::VectorXd> meas, std::vector<MatrixXdr> R = {}, std::vector<std::vector<double>> extra_args = {{}}, bool augment = false);
