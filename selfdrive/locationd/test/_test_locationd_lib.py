...
void localizer_handle_msg_bytes(Localizer_t localizer, const char *data, size_t size);'''
  ...
  def test_device_fell(self):
    msg = messaging.new_message('sensorEventsDEPRECATED', 1)
    msg.sensorEventsDEPRECATED[0].sensor = 1
    msg.sensorEventsDEPRECATED[0].timestamp = msg.logMonoTime
    msg.sensorEventsDEPRECATED[0].type = 1
    msg.sensorEventsDEPRECATED[0].init('acceleration')
    msg.sensorEventsDEPRECATED[0].acceleration.v = [10.0, 0.0, 0.0]  # zero with gravity
    self.localizer_handle_msg(msg)
    ...
    msg.sensorEventsDEPRECATED[0].type = 1
    msg.sensorEventsDEPRECATED[0].init('acceleration')
    msg.sensorEventsDEPRECATED[0].acceleration.v = [50.1, 0.0, 0.0]  # more than 40 m/s**2
    self.localizer_handle_msg(msg)
