...
class Calibrator():
  ...
  def get_msg(self):
    ...
    msg.liveCalibration.extrinsicMatrix = extrinsic_matrix.flatten().astype(float)
    msg.liveCalibration.rpyCalib = smooth_rpy.astype(float)
    msg.liveCalibration.rpyCalibSpread = self.calib_spread.astype(float)
    return msg
