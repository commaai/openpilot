...
ALERTS = {
  ...
  'aeb': ('Emergency braking, initially silent', 'BRAKE!', 'Emergency Braking: Risk of Collision', 'critical', 'full', 'none'),
  'stock_aeb': ('Stock AEB, initially silent', 'BRAKE!', 'Stock AEB: Risk of Collision', 'critical', 'full', 'none'),
...
SCENARIOS = {
  **{name: scenario(ALERTS[name][0], [(name, 12)], 8.)
  ...
  'aeb': scenario('Initially silent AEB', [('aeb', 12)], 8., 'Silent for eight seconds, then max at full volume.'),
  'stock_aeb': scenario('Initially silent stock AEB', [('stock_aeb', 12)], 8.),
  ...
  'silent_continuation': scenario('Silent red keeps timer', [('distracted', 6), ('aeb', 1), ('distracted', 10)], 8.),
  'orange_reset': scenario('Orange interrupts timer', [('distracted', 6), ('dm_orange', 1), ('distracted', 10)], 15.),
  'switch': scenario('Continuous red: DM → collision', [('distracted', 4), ('fcw', 8)], 8., 'Continuous red activity keeps the timer.'),
