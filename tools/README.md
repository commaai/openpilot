...
Most of openpilot should work natively on macOS. On Windows you can use WSL. Running natively on any other system is not recommended and will require modifications.
