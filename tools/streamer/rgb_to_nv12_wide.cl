...
inline void convert_2_ys_2(__global uchar * out_yuv, int yi, const uchar8 rgbs1) {
  uchar2 yy = (uchar2)(
...
inline void convert_4_ys_2(__global uchar * out_yuv, int yi, const uchar8 rgbs1, const uchar8 rgbs3) {
...
inline void convert_uv_2(__global uchar * out_yuv, int uvi,
...
inline void convert_2_uvs_2(__global uchar * out_yuv, int uvi,
...
__kernel void rgb_to_nv12_opy(__global uchar const * const rgb,
                    __global uchar * out_yuv)
{
  ...
  if(num_row == 4) {
    ...
    if(num_col == 4) {
      convert_4_ys_2(out_yuv, yi_start, rgbs0_0, rgbs0_1);
      convert_4_ys_2(out_yuv, yi_start + WIDTH, rgbs1_0, rgbs1_1);
      convert_4_ys_2(out_yuv, yi_start + WIDTH * 2, rgbs2_0, rgbs2_1);
      convert_4_ys_2(out_yuv, yi_start + WIDTH * 3, rgbs3_0, rgbs3_1);
      convert_2_uvs_2(out_yuv, uvi, rgbs0_0, rgbs1_0, rgbs0_1, rgbs1_1);
      convert_2_uvs_2(out_yuv, uvi + WIDTH, rgbs2_0, rgbs3_0, rgbs2_1, rgbs3_1);
    } else if(num_col == 2) {
      convert_2_ys_2(out_yuv, yi_start, rgbs0_0);
      convert_2_ys_2(out_yuv, yi_start + WIDTH, rgbs1_0);
      convert_2_ys_2(out_yuv, yi_start + WIDTH * 2, rgbs2_0);
      convert_2_ys_2(out_yuv, yi_start + WIDTH * 3, rgbs3_0);
      convert_uv_2(out_yuv, uvi, rgbs0_0, rgbs1_0);
      convert_uv_2(out_yuv, uvi + WIDTH, rgbs2_0, rgbs3_0);
    }
  } else {
    const uchar8 rgbs0_0 = vload8(0, rgb + bgri_start);
    const uchar8 rgbs0_1 = vload8(0, rgb + bgri_start + 8);
