...
def main():
  ...
  replay_proc = subprocess.Popen(["./tools/replay/replay", "-s", str(START), "--no-loop", ROUTE], env=env, stdout=DEVNULL, stderr=DEVNULL)
  ...
  print(f'starting at {START} seconds and clipping {DURATION} seconds')
  time.sleep(DURATION)
