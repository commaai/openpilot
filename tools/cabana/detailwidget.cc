...
DetailWidget::DetailWidget(ChartsWidget *charts, QWidget *parent) : charts(charts), QWidget(parent) {
  ...
  toolbar->addAction(QIcon("./images/edit.png"), "", this, &DetailWidget::editMsg)->setToolTip(tr("Edit Message"));
  remove_msg_act = toolbar->addAction(QIcon("./images/x.png"), "", this, &DetailWidget::removeMsg);
